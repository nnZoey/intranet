...
class PersonResourceIT {
    ...
    void createPerson() throws Exception {
        ...
        assertThat(testPerson.getPersonalPhoneNumber()).isEqualTo(DEFAULT_PERSONAL_PHONE_NUMBER);
        assertThat(testPerson.getPersonalEmail()).isEqualTo(DEFAULT_PERSONAL_EMAIL);
        assertThat(testPerson.getPermanentAddress()).isEqualTo(DEFAULT_PERMANENT_ADDRESS);
        assertThat(testPerson.getTemporaryAddress()).isEqualTo(DEFAULT_TEMPORARY_ADDRESS);
        assertThat(testPerson.getIdNumber()).isEqualTo(DEFAULT_ID_NUMBER);
        assertThat(testPerson.getIdIssuedDate()).isEqualTo(DEFAULT_ID_ISSUED_DATE);
        assertThat(testPerson.getIdIssuedLocation()).isEqualTo(DEFAULT_ID_ISSUED_LOCATION);
        assertThat(testPerson.getSocialInsuranceNumber()).isEqualTo(DEFAULT_SOCIAL_INSURANCE_NUMBER);
        assertThat(testPerson.getTaxIdentificationNumber()).isEqualTo(DEFAULT_TAX_IDENTIFICATION_NUMBER);
        assertThat(testPerson.getQualification()).isEqualTo(DEFAULT_QUALIFICATION);
    }
    ...
    void checkPersonalPhoneNumberIsRequired() throws Exception {
        int databaseSizeBeforeTest = personRepository.findAll().size();
        // set the field null
        person.setPersonalPhoneNumber(null);
    ...
    void checkIdIssuedLocationIsRequired() throws Exception {
        int databaseSizeBeforeTest = personRepository.findAll().size();
        // set the field null
        person.setIdIssuedLocation(null);
    ...
    void putNewPerson() throws Exception {
        ...
        assertThat(testPerson.getPersonalPhoneNumber()).isEqualTo(UPDATED_PERSONAL_PHONE_NUMBER);
        assertThat(testPerson.getPersonalEmail()).isEqualTo(UPDATED_PERSONAL_EMAIL);
        assertThat(testPerson.getPermanentAddress()).isEqualTo(UPDATED_PERMANENT_ADDRESS);
        assertThat(testPerson.getTemporaryAddress()).isEqualTo(UPDATED_TEMPORARY_ADDRESS);
        assertThat(testPerson.getIdNumber()).isEqualTo(UPDATED_ID_NUMBER);
        assertThat(testPerson.getIdIssuedDate()).isEqualTo(UPDATED_ID_ISSUED_DATE);
        assertThat(testPerson.getIdIssuedLocation()).isEqualTo(UPDATED_ID_ISSUED_LOCATION);
        assertThat(testPerson.getSocialInsuranceNumber()).isEqualTo(UPDATED_SOCIAL_INSURANCE_NUMBER);
        assertThat(testPerson.getTaxIdentificationNumber()).isEqualTo(UPDATED_TAX_IDENTIFICATION_NUMBER);
        assertThat(testPerson.getQualification()).isEqualTo(UPDATED_QUALIFICATION);
    }
