...
import vn.leap.intranet.service.ProjectQueryService;
import vn.leap.intranet.service.ProjectService;
import vn.leap.intranet.service.criteria.ProjectCriteria;
import vn.leap.intranet.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link vn.leap.intranet.domain.Project}.
 */
@RestController
@RequestMapping("/api")
