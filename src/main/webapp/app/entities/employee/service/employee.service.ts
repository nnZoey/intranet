...
export class EmployeeService {
  ...
  protected convertDateFromClient(employee: IEmployee): IEmployee {
    return Object.assign({}, employee, {
      ...
      hiredDate: employee.hiredDate?.isValid() ? employee.hiredDate.toJSON() : undefined,
      ...
      dob: employee.dob?.isValid() ? employee.dob.toJSON() : undefined,
      idIssuedDate: employee.idIssuedDate?.isValid() ? employee.idIssuedDate.toJSON() : undefined,
    });
  }
  ...
  protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
    if (res.body) {
      ...
      res.body.hiredDate = res.body.hiredDate ? dayjs(res.body.hiredDate) : undefined;
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((employee: IEmployee) => {
        ...
        employee.hiredDate = employee.hiredDate ? dayjs(employee.hiredDate) : undefined;
        ...
        employee.dob = employee.dob ? dayjs(employee.dob) : undefined;
        employee.idIssuedDate = employee.idIssuedDate ? dayjs(employee.idIssuedDate) : undefined;
      });
    }
    return res;
  }
