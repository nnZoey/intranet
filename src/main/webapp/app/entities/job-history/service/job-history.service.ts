...
export class JobHistoryService {
  ...
  protected convertDateFromClient(jobHistory: IJobHistory): IJobHistory {
    return Object.assign({}, jobHistory, {
      effectiveDate: jobHistory.effectiveDate?.isValid() ? jobHistory.effectiveDate.toJSON() : undefined,
      contractStartDate: jobHistory.contractStartDate?.isValid() ? jobHistory.contractStartDate.toJSON() : undefined,
      contractEndDate: jobHistory.contractEndDate?.isValid() ? jobHistory.contractEndDate.toJSON() : undefined,
    });
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((jobHistory: IJobHistory) => {
        jobHistory.effectiveDate = jobHistory.effectiveDate ? dayjs(jobHistory.effectiveDate) : undefined;
        jobHistory.contractStartDate = jobHistory.contractStartDate ? dayjs(jobHistory.contractStartDate) : undefined;
        jobHistory.contractEndDate = jobHistory.contractEndDate ? dayjs(jobHistory.contractEndDate) : undefined;
      });
    }
    return res;
  }
