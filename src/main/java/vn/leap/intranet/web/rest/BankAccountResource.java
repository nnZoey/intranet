...
/**
 * REST controller for managing {@link vn.leap.intranet.domain.BankAccount}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<BankAccount> result = bankAccountRepository
            ...
            .map(existingBankAccount -> {
                if (bankAccount.getBankAccount() != null) {
                    existingBankAccount.setBankAccount(bankAccount.getBankAccount());
                }
                if (bankAccount.getBankCode() != null) {
                    existingBankAccount.setBankCode(bankAccount.getBankCode());
                }
