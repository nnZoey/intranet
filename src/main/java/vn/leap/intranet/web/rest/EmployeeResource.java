...
import vn.leap.intranet.service.EmployeeQueryService;
...
public class EmployeeResource {
    ...
    public ResponseEntity<Employee> getEmployeeUser(@PathVariable Long id) {
        log.debug("REST request to get Employee by 1: {}", id);
