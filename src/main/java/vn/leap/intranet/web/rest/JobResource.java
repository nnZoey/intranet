...
import vn.leap.intranet.service.JobQueryService;
import vn.leap.intranet.service.JobService;
import vn.leap.intranet.service.criteria.JobCriteria;
import vn.leap.intranet.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link vn.leap.intranet.domain.Job}.
 */
@RestController
@RequestMapping("/api")
