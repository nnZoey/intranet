...
*/
(function (J, ea) {
  typeof module === 'object' && module.exports ? (module.exports = J.document ? ea(J) : ea) : (J.Highcharts = ea(J));
  ...
  function W(a, b, c) {
    var d, e;
    if (Da(b)) t(c) ? a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b));
  ...
  function ca(a, b, c, d, e) {
    a = B.createElement(a);
    b && w(a, b);
    e && I(a, { padding: 0, border: 'none', margin: 0 });
    c && I(a, c);
    d && d.appendChild(a);
    return a;
  }
      ...
      if (d) {
        ...
        if (f.length)
          (f = f.join(':')),
            ...
            /f$/.test(f)
              ? ((i = (i = f.match(g)) ? i[1] : -1),
                e !== null && (e = z.numberFormat(e, i, h.decimalPoint, f.indexOf(',') > -1 ? h.thousandsSep : '')))
              : (e = la(f, e));
      }
      j.push(e);
      a = a.slice(c + 1);
  ...
  function Ab(a) {
    return X.pow(10, U(X.log(a) / X.LN10));
  }
  ...
  function Pb() {
    ...
    rb = function (a, c, d, h, i, j) {
      var k;
      b ? ((k = da.UTC.apply(0, arguments)), (k += gb(k))) : (k = new da(a, c, p(d, 1), p(h, 0), p(i, 0), p(j, 0)).getTime());
      return k;
    };
    Cb = c + 'Minutes';
    Db = c + 'Hours';
  ...
  function va(a) {
    if (!(this instanceof va)) return new va(a);
    this.init(a);
  }
  function Y() {}
  function db(a, b, c, d) {
  ...
  var u,
    ...
    Ba = X.PI,
    oa = (Ba * 2) / 360,
    La = (J.navigator && J.navigator.userAgent) || '',
    Vb = J.opera,
    Ja = /(msie|trident|edge)/i.test(La) && !Vb,
    sb = B && B.documentMode === 8,
    tb = !Ja && /AppleWebKit/.test(La),
    Za = /Firefox/.test(La),
    lb = /(Mobile|Android|Windows Phone)/.test(La),
    Qa = 'http://www.w3.org/2000/svg',
    ha = B && B.createElementNS && !!B.createElementNS(Qa, 'svg').createSVGRect,
    $b = Za && parseInt(La.split('Firefox/')[1], 10) < 4,
    pa = B && !ha && !Ja && !!B.createElement('canvas').getContext,
    $a,
    eb,
    Wb = {},
    Kb = 0,
  ...
  la = function (a, b, c) {
    if (!t(b) || isNaN(b)) return O.lang.invalidDate || '';
  ...
  wa = function (a, b) {
    var c;
    if (b === 'width') return Math.min(a.offsetWidth, a.scrollWidth) - wa(a, 'padding-left') - wa(a, 'padding-right');
    else if (b === 'height') return Math.min(a.offsetHeight, a.scrollHeight) - wa(a, 'padding-top') - wa(a, 'padding-bottom');
    return (c = J.getComputedStyle(a, void 0)) && G(c.getPropertyValue(b));
  };
  ra = function (a, b) {
  ...
  Lb = function (a) {
    ...
    return {
      top: a.top + (J.pageYOffset || b.scrollTop) - (b.clientTop || 0),
      left: a.left + (J.pageXOffset || b.scrollLeft) - (b.clientLeft || 0),
    };
  };
  Ta = function (a) {
  ...
  R = function (a, b, c) {
    function d(b, c) {
      a.removeEventListener
        ...
        : a.attachEvent && ((c = a.hcEventsIE[c.toString()]), a.detachEvent('on' + b, c));
    }
    function e() {
      var c, e, f;
    ...
    if (g)
      b
        ? ((f = g[b] || []), c ? ((h = ra(c, f)), h > -1 && (f.splice(h, 1), (g[b] = f)), d(b, c)) : (e(), (g[b] = [])))
        : (e(), (a.hcEvents = {}));
  };
  M = function (a, b, c, d) {
    var e;
  ...
  fb = function (a, b, c) {
    var d,
      ...
      g,
      h;
    fa(c) || ((d = arguments), (c = { duration: d[2], easing: d[3], complete: d[4] }));
    if (!ta(c.duration)) c.duration = 400;
    ...
    for (h in b)
      (g = new yb(a, c, h)),
        (f = null),
        h === 'd'
          ? ((g.paths = g.initPath(a, a.d, b.d)), (g.toD = b.d), (d = 0), (f = 1))
          : a.attr
          ? (d = a.attr(h))
          : ((d = parseFloat(wa(a, h)) || 0), h !== 'opacity' && (e = 'px')),
        f || (f = b[h]),
        f.match && f.match('px') && (f = f.replace(/px/g, '')),
        g.run(d, f, e);
  };
  if (J.jQuery)
    J.jQuery.fn.highcharts = function () {
      var a = [].slice.call(arguments);
      if (this[0])
        return a[0] ? (new z[Da(a[0]) ? a.shift() : 'Chart'](this[0], a[0], a[1]), this) : $[W(this[0], 'data-highcharts-chart')];
    };
  B &&
    !B.defaultView &&
    (wa = function (a, b) {
      ...
      b === 'opacity' && (b = 'filter');
      if (c) return (a.style.zoom = 1), a[c] - 2 * wa(a, 'padding');
      c =
        a.currentStyle[
  ...
  va.prototype = {
    ...
    init: function (a) {
      ...
      if ((this.input = a) && a.stops)
        this.stops = sa(a.stops, function (a) {
          return new va(a[1]);
        });
    ...
    brighten: function (a) {
      ...
      else if (ta(a) && a !== 0) for (b = 0; b < 3; b++) (c[b] += G(a * 255)), c[b] < 0 && (c[b] = 0), c[b] > 255 && (c[b] = 255);
      return this;
    },
  ...
  Y.prototype = {
    ...
    init: function (a, b) {
      this.element = b === 'span' ? ca(b) : B.createElementNS(Qa, b);
      this.renderer = a;
    },
    ...
    colorGradient: function (a, b, c) {
      ...
      if (f) {
        ...
        f === 'radialGradient' &&
          o &&
          !t(g.gradientUnits) &&
          ((h = g), (g = C(g, d.getRadialAttr(o, h), { gradientUnits: 'userSpaceOnUse' })));
        for (q in g) q !== 'id' && r.push(q, g[q]);
        for (q in k) r.push(k[q]);
        r = r.join(',');
        i[r]
          ? (o = i[r].attr('id'))
          : ((g.id = o = 'highcharts-' + Kb++),
    ...
    attr: function (a, b, c) {
      var d,
        ...
        g = this,
        h;
      typeof a === 'string' && b !== u && ((d = a), (a = {}), (a[d] = b));
      if (typeof a === 'string') g = (this[a + 'Getter'] || this._defaultGetter).call(this, a, e);
        ...
        for (d in a) {
          ...
          h = !1;
          this.symbolName &&
            /^(x|y|width|height|r|start|end|innerR|anchorX|anchorY)/.test(d) &&
    ...
    updateShadows: function (a, b, c) {
      for (var d = this.shadows, e = d.length; e--; )
        c.call(null, a === 'height' ? Math.max(b - (d[e].cutHeight || 0), 0) : a === 'd' ? this.d : b, a, d[e]);
    },
    addClass: function (a) {
      var b = this.element,
        c = W(b, 'class') || '';
    ...
    css: function (a) {
      ...
      if (e) {
        ...
        b && (a = w(b, c));
        this.styles = a;
        e && (pa || (!ha && this.renderer.forExport)) && delete a.width;
        if (Ja && !ha) I(this.element, a);
        else {
          b = function (a, b) {
      ...
      eb && a === 'click'
        ? ((d.ontouchstart = function (a) {
          ...
          (d.onclick = function (a) {
            (La.indexOf('Android') === -1 || da.now() - (c.touchEventFired || 0) > 1100) && b.call(d, a);
          }))
        : (d['on' + a] = b);
      return this;
    },
    ...
    align: function (a, b, c) {
      ...
      if (a) {
        if (((this.alignOptions = a), (this.alignByTranslate = b), !c || Da(c)))
          (this.alignTo = d = c || 'renderer'), Aa(f, this), f.push(this), (c = null);
    ...
    getBBox: function (a, b) {
      ...
      g = f * oa;
      e !== u &&
        ((q = ['', f || 0, i && i.fontSize, h.style.width].join(',')),
        (q = e === '' || ac.test(e) ? 'num:' + e.toString().length + q : e + q));
      q && !a && (c = m[q]);
      if (!c) {
        if (h.namespaceURI === Qa || d.forExport) {
          try {
            (l =
              ...
              Za && k.textShadow ? ((j = k.textShadow), (k.textShadow = '')) : l && l('none'),
              (c = h.getBBox ? w({}, h.getBBox()) : { width: h.offsetWidth, height: h.offsetHeight }),
        ...
        if (d.isSVG) {
          d = c.width;
          e = c.height;
          if (Ja && i && i.fontSize === '11px' && e.toPrecision(3) === '16.9') c.height = e = 14;
          if (f) (c.width = Q(e * ia(g)) + Q(d * aa(g))), (c.height = Q(e * aa(g)) + Q(d * ia(g)));
        }
        if (q) {
    ...
    destroy: function () {
      ...
      a.alignTo && Aa(a.renderer.alignedObjects, a);
    ...
    titleSetter: function (a) {
      ...
      b || ((b = B.createElementNS(Qa, 'title')), this.element.appendChild(b));
      b.appendChild(B.createTextNode(String(p(a), '').replace(/<[^>]*>/g, '')));
    },
    ...
    zIndexSetter: function (a, b) {
      ...
      if (e) {
        ...
        for (i = 0; i < d.length && !h; i++)
          if (((e = d[i]), (f = W(e, 'zIndex')), e !== g && (G(f) > a || (!t(a) && t(f))))) c.insertBefore(g, e), (h = !0);
        h || c.appendChild(g);
      }
      return h;
    },
  ...
  Y.prototype.translateXSetter =
    Y.prototype.translateYSetter =
    Y.prototype.rotationSetter =
  ...
  Y.prototype['stroke-widthSetter'] = Y.prototype.strokeSetter = function (a, b, c) {
    ...
    if (this.stroke && this['stroke-width'])
      (this.strokeWidth = this['stroke-width']),
        Y.prototype.fillSetter.call(this, this.stroke, 'stroke', c),
  ...
  xa.prototype = {
    ...
    init: function (a, b, c, d, e, f) {
      ...
      g = d.element;
      a.appendChild(g);
      a.innerHTML.indexOf('xmlns') === -1 && W(g, 'xmlns', Qa);
      this.isSVG = !0;
      this.box = g;
      this.boxWrapper = d;
      this.alignedObjects = [];
      this.url =
        (Za || tb) && B.getElementsByTagName('base').length
          ? J.location.href
              .replace(/#.*?$/, '')
              .replace(/([\('\)])/g, '\\$1')
              .replace(/ /g, '%20')
          : '';
      this.createElement('desc').add().element.appendChild(B.createTextNode('Created with Highstock 4.2.3'));
      ...
      this.setSize(b, c, !1);
      var h;
      if (Za && a.getBoundingClientRect)
        (this.subPixelFix = b =
          function () {
            I(a, { left: 0, top: 0 });
            h = a.getBoundingClientRect();
            I(a, { left: Fa(h.left) - h.left + 'px', top: Fa(h.top) - h.top + 'px' });
          }),
          b(),
          D(J, 'resize', b);
    },
    getStyle: function (a) {
      return (this.style = w({ fontFamily: '"Lucida Grande", "Lucida Sans Unicode", Arial, Helvetica, sans-serif', fontSize: '12px' }, a));
    },
    isHidden: function () {
    ...
    destroy: function () {
      ...
      this.subPixelFix && R(J, 'resize', this.subPixelFix);
    ...
    buildText: function (a) {
      for (
        var b = a.element,
          ...
          r = g.length,
          A = l && !a.added && this.box,
          T = function (a) {
            return m
              ? G(m)
              : c.fontMetrics(/(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : (k && k.fontSize) || c.style.fontSize || 12, a).h;
          },
          v = function (a) {
        ...
        b.removeChild(g[r]);
      !f && !o && !q && e.indexOf(' ') === -1
        ? b.appendChild(B.createTextNode(v(e)))
        : ((h = /<.*style="([^"]+)".*>/),
          (i = /<.*href="(http[^"]+)".*>/),
          A && A.appendChild(b),
          (e = f
          ...
          n(e, function (e, f) {
            ...
            n(g, function (e) {
              if (e !== '' || g.length === 1) {
                var o = {},
                  r = B.createElementNS(Qa, 'tspan'),
                  A;
                h.test(e) && ((A = e.match(h)[1].replace(/(;| |^)color([ :])/, '$1fill$2')), W(r, 'style', A));
                i.test(e) && !d && (W(r, 'onclick', 'location.href="' + e.match(i)[1] + '"'), I(r, { cursor: 'pointer' }));
                e = v(e.replace(/<(.|\n)*?>/g, '') || ' ');
                if (e !== ' ') {
                  ...
                  W(r, o);
                  b.appendChild(r);
                  !m && f && (!ha && d && I(r, { display: 'block' }), W(r, 'dy', T(r)));
                  if (l) {
                    for (
                      var o = e.replace(/([^\^])-/g, '$1- ').split(' '),
                        p = g.length > 1 || f || (o.length > 1 && k.whiteSpace !== 'nowrap'),
                        x,
                        n,
                        t,
                        u = [],
                        ...
                        C = e,
                        z = C.length;
                      (p || q) && (o.length || u.length);

                    )
                      (a.rotation = 0),
                        (x = a.getBBox(!0)),
                        (t = x.width),
                        !ha && c.forExport && (t = c.measureSpanWidth(r.firstChild.data, a.styles)),
                        (x = t > l),
                        n === void 0 && (n = x),
                        q && n
                          ? ((z /= 2),
                            C === '' || (!x && z < 0.5)
                              ? (o = [])
                              : (x && (n = !0),
                                (C = e.substring(0, C.length + (x ? -1 : 1) * Fa(z))),
                                (o = [C + (l > 3 ? '\u2026' : '')]),
                          ...
                          ? ((o = u),
                            (u = []),
                            o.length &&
                              (y++, (r = B.createElementNS(Qa, 'tspan')), W(r, { dy: s, x: j }), A && W(r, 'style', A), b.appendChild(r)),
                            t > l && (l = t))
                          : (r.removeChild(r.firstChild), u.unshift(o.pop())),
                        o.length && r.appendChild(B.createTextNode(o.join(' ').replace(/- /g, '-')));
                    n && a.attr('title', a.textStr);
                    a.rotation = w;
                  }
                  m++;
                }
    ...
    button: function (a, b, c, d, e, f, g, h, i) {
      ...
      A = h.style;
      delete h.style;
      D(j.element, Ja ? 'mouseover' : 'mouseenter', function () {
        k !== 3 && j.attr(f).css(q);
      });
      D(j.element, Ja ? 'mouseout' : 'mouseleave', function () {
        k !== 3 && ((l = [e, f, g][k]), (m = [o, q, r][k]), j.attr(l).css(m));
      });
      j.setState = function (a) {
        (j.state = k = a) ? (a === 2 ? j.attr(g).css(r) : a === 3 && j.attr(h).css(A)) : j.attr(e).css(o);
      };
      return j
        .on('click', function (a) {
          k !== 3 && d.call(j, a);
    ...
    rect: function (a, b, c, d, e, f) {
      var e = fa(a) ? a.r : e,
        ...
        a = fa(a) ? a : a === u ? {} : { x: a, y: b, width: s(c, 0), height: s(d, 0) };
      if (f !== u) (g.strokeWidth = f), (a = g.crisp(a));
      if (e) a.r = e;
    ...
    symbol: function (a, b, c, d, e, f) {
      var g = this,
        ...
        k,
        l;
      if (i) (h = this.path(i)), w(h, { symbolName: a, x: b, y: c, width: d, height: e }), f && w(h, f);
      else if (j.test(a))
        (l = function (a, b) {
          a.element && (a.attr({ width: b[0], height: b[1] }), a.alignByTranslate || a.translate(y((d - b[0]) / 2), y((e - b[1]) / 2)));
        }),
          (k = a.match(j)[1]),
          (a = Wb[k] || (f && f.width && f.height && [f.width, f.height])),
          (h = this.image(k).attr({ x: b, y: c })),
          (h.isImg = !0),
          a
            ? l(h, a)
            : (h.attr({ width: 0, height: 0 }),
              ca('img', {
                onload: function () {
                  this.width === 0 && (I(this, { position: 'absolute', top: '-999em' }), B.body.appendChild(this));
                  l(h, (Wb[k] = [this.width, this.height]));
    ...
    fontMetrics: function (a, b) {
      ...
      !a && b && J.getComputedStyle && ((b = b.element || b), (a = (c = J.getComputedStyle(b, '')) && c.fontSize));
    ...
    label: function (a, b, c, d, e, f, g, h, i) {
      ...
      L = function () {
        var a, b;
        a = l.element.style;
        o = (p === void 0 || v === void 0 || k.styles.textAlign) && t(l.textStr) && l.getBBox();
        k.width = (p || o.width || 0) + 2 * r + A;
        k.height = (v || o.height || 0) + 2 * r;
        s = r + j.fontMetrics(a && a.fontSize, l).b;
        if (z) {
          if (!m)
            (a = ja),
              (b = (h ? -s : 0) + ja),
              (k.box = m = d ? j.symbol(d, a, b, k.width, k.height, Ua) : j.rect(a, b, k.width, k.height, 0, Ua['stroke-width'])),
              m.isImg || m.attr('fill', 'none'),
              m.add(k);
          m.isImg || m.attr(w({ width: y(k.width), height: y(k.height) }, Ua));
          Ua = null;
        }
      };
      E = function () {
        var a = k.styles,
          ...
          c;
        c = h ? 0 : s;
        if (t(p) && o && (a === 'center' || a === 'right')) b += { center: 0.5, right: 1 }[a] * (p - o.width);
        if (b !== l.x || c !== l.y) l.attr('x', b), c !== u && l.attr('y', c);
        l.x = b;
        l.y = c;
      };
      B = function (a, b) {
      ...
      return w(k, {
        ...
        destroy: function () {
          R(k.element, 'mouseenter');
          R(k.element, 'mouseleave');
          l && (l = l.destroy());
          m && (m = m.destroy());
          Y.prototype.destroy.call(k);
          k = j = L = E = B = null;
        },
      });
    },
  ...
  w(Y.prototype, {
        ...
        if (b.tagName === 'SPAN') {
          ...
          if (m !== this.cTT) {
            ...
            if (b.offsetWidth > k && /[ \-]/.test(b.textContent || b.innerText))
              I(b, { width: k + 'px', display: 'block', whiteSpace: l || 'normal' }), (this.hasTextWidth = !0);
            else if (this.hasTextWidth) I(b, { width: '', display: '', whiteSpace: l || 'nowrap' }), (this.hasTextWidth = !1);
            this.getSpanCorrection(this.hasTextWidth ? k : b.offsetWidth, j, h, i, g);
          }
          I(b, { left: e + (this.xCorr || 0) + 'px', top: f + (this.yCorr || 0) + 'px' });
          if (tb) j = b.offsetHeight;
          this.cTT = m;
        }
    ...
    setSpanRotation: function (a, b, c) {
      var d = {},
        e = Ja ? '-ms-transform' : tb ? '-webkit-transform' : Za ? 'MozTransform' : Vb ? '-o-transform' : '';
      d[e] = d.transform = 'rotate(' + a + 'deg)';
      d[e + (Za ? 'Origin' : '-origin')] = d.transformOrigin = b * 100 + '% ' + c + 'px';
      I(this.element, d);
    },
          ...
          if ((this.parentGroup = a)) {
            if (((b = a.div), !b)) {
              ...
              n(k.reverse(), function (a) {
                ...
                e && (e = { className: e });
                b = a.div =
                  a.div || ca(Ya, e, { position: 'absolute', left: (a.translateX || 0) + 'px', top: (a.translateY || 0) + 'px' }, b || c);
                d = b.style;
                w(a, {
  ...
  if (!ha && !pa)
    (Z = {
      ...
      getSpanCorrection: function (a, b, c, d, e) {
        ...
        e &&
          e !== 'left' &&
          ((this.xCorr -= a * c * (f < 0 ? -1 : 1)), d && (this.yCorr -= h * c * (g < 0 ? -1 : 1)), I(this.element, { textAlign: e }));
      },
      pathToVML: function (a) {
        for (var b = a.length, c = []; b--; )
          if (ta(a[b])) c[b] = y(a[b] * 10) - 5;
          else if (a[b] === 'Z') c[b] = 'x';
      ...
      clip: function (a) {
        ...
        a
          ? ((c = a.members),
            ...
            (a = a.getCSS(b)))
          : (b.destroyClip && b.destroyClip(), (a = { clip: sb ? 'inherit' : 'rect(auto)' }));
        return b.css(a);
      },
      ...
      shadow: function (a, b, c) {
        ...
        if (a) {
          ...
          for (e = 1; e <= 3; e++) {
            ...
            h = ca(g.prepVML(j), null, { left: G(i.left) + p(a.offsetX, 1), top: G(i.top) + p(a.offsetY, 1) });
            if (c) h.cutOff = l + 1;
      ...
      setAttr: function (a, b) {
        sb ? (this.element[a] = b) : this.element.setAttribute(a, b);
      },
      classSetter: function (a) {
        this.element.className = a;
      },
      dashstyleSetter: function (a, b, c) {
        (c.getElementsByTagName('stroke')[0] || ca(this.renderer.prepVML(['<stroke/>']), null, null, c))[b] = a || 'solid';
        this[b] = a;
      },
      dSetter: function (a, b, c) {
        var d = this.shadows,
      ...
      'fill-opacitySetter': function (a, b, c) {
        ca(this.renderer.prepVML(['<', b.split('-')[0], ' opacity="', a, '"/>']), null, null, c);
      },
      opacitySetter: qa,
      rotationSetter: function (a, b, c) {
        c = c.style;
        this[b] = c[b] = a;
        c.left = -y(ia(a * oa) + 1) + 'px';
        c.top = y(aa(a * oa)) + 'px';
      },
      ...
      visibilitySetter: function (a, b, c) {
        a === 'inherit' && (a = 'visible');
        this.shadows &&
          n(this.shadows, function (c) {
            c.style[b] = a;
          });
        c.nodeName === 'DIV' && ((a = a === 'hidden' ? '-999em' : 0), sb || (c.style[b] = a ? 'visible' : 'hidden'), (b = 'top'));
        c.style[b] = a;
      },
      ...
      (z.VMLElement = Z = ka(Y, Z)),
      (Z.prototype.ySetter = Z.prototype.widthSetter = Z.prototype.heightSetter = Z.prototype.xSetter),
      (Z = {
        Element: Z,
        isIE8: La.indexOf('MSIE 8.0') > -1,
        init: function (a, b, c, d) {
          var e;
          this.alignedObjects = [];
          d = this.createElement(Ya).css(w(this.getStyle(d), { position: 'relative' }));
          e = d.element;
          ...
          return w(e, {
            ...
            getCSS: function (a) {
              var b = a.element,
                ...
                b = e + this.width,
                f = d + this.height,
                d = { clip: 'rect(' + y(a ? e : d) + 'px,' + y(a ? f : b) + 'px,' + y(a ? b : f) + 'px,' + y(a ? d : e) + 'px)' };
              !a && sb && c === 'DIV' && w(d, { width: b + 'px', height: f + 'px' });
              return d;
            },
        ...
        color: function (a, b, c, d) {
            ...
            if (c === 'fill')
              if (i === 'gradient')
                (c = m.x1 || m[0] || 0),
                  ...
                  (o = m.x2 || m[2] || 0),
                  (m = m.y2 || m[3] || 0),
                  (v = 'angle="' + (90 - (X.atan((m - a) / (o - c)) * 180) / Ba) + '"'),
                  ja();
              else {
                var j = m.r,
                  Ua = j * 2,
                  ...
                  j = function () {
                    y &&
                      ((w = d.getBBox()),
                      (s += (y[0] - w.x) / w.width - 0.5),
                      (u += (y[1] - w.y) / w.height - 0.5),
                      (Ua *= y[2] / w.width),
                      (t *= y[2] / w.height));
                    v =
                      'src="' +
                      O.global.VMLRadialGradientURL +
                      '" size="' +
                      Ua +
                      ',' +
                      t +
          ...
          } else if (g.test(a) && b.tagName !== 'IMG') (f = va(a)), d[c + '-opacitySetter'](f.get('a'), c, b), (j = f.get('rgb'));
          else {
        ...
        invertChild: function (a, b) {
          ...
          I(a, { flip: 'x', left: G(d.width) - (e ? G(e.top) : 1), top: G(d.height) - (e ? G(e.left) : 1), rotation: -90 });
        ...
        symbols: {
          ...
          rect: function (a, b, c, d, e) {
            return xa.prototype.symbols[!t(e) || !e.r ? 'square' : 'callout'].call(0, a, b, c, d, e);
          },
        },
      }),
      (z.VMLRenderer = nb =
  ...
  db.prototype = {
    addLabel: function () {
      ...
      this.isFirst = i;
      this.isLast = j;
      b = a.labelFormatter.call({ axis: a, chart: c, isFirst: i, isLast: j, dateTimeLabelFormat: k, value: a.isLog ? na(za(e)) : e });
      t(d)
        ? d && d.attr({ text: b })
        : ((this.labelLength =
            (this.label = d = t(b) && g.enabled ? c.renderer.text(b, 0, 0, g.useHTML).css(C(g.style)).add(a.labelGroup) : null) &&
            d.getBBox().width),
          (this.rotation = 0));
    },
    ...
    handleOverflow: function (a) {
      var b = this.axis,
        ...
        m,
        o = {};
      if (h) h < 0 && c - i * j < f ? (m = y(c / aa(h * oa) - f)) : h > 0 && c + i * j > e && (m = y((d - c) / aa(h * oa)));
      else if (
        ((d = c + (1 - i) * j),
        c - i * j < f ? (k = a.x + k * (1 - i) - f) : d > e && ((k = e - a.x + k * i), (l = -1)),
        (k = E(b.slotWidth, k)),
        k < b.slotWidth && b.labelAlign === 'center' && (a.x += l * (b.slotWidth - k - i * (b.slotWidth - E(j, k)))),
    ...
    getLabelPosition: function (a, b, c, d, e, f, g, h) {
      var i = this.axis,
        ...
        o = e.y;
      t(o) || (o = i.side === 2 ? m.y + 8 : (o = aa(c.rotation * oa) * (m.y - c.getBBox(!1, 0).height / 2)));
    ...
    render: function (a, b, c) {
      var d = this.axis,
        ...
        y = s.x,
        s = s.y,
        w = (g && y === d.pos + d.len) || (!g && s === d.pos) ? -1 : 1,
        c = p(c, 1);
      this.isActive = !0;
      if (q) {
        j = d.getPlotLinePath(j + t, q * w, b, !0);
        if (l === u) {
          l = { stroke: r, 'stroke-width': q };
          if (A) l.dashstyle = A;
          if (!h) l.zIndex = 1;
          if (b) l.opacity = 0;
      ...
      if (m && n)
        x === 'inside' && (n = -n),
          d.opposite && (n = -n),
          (h = this.getMarkPath(y, s, n, m * w, g, f)),
          o ? o.animate({ d: h, opacity: c }) : (this.mark = f.path(h).attr({ stroke: v, 'stroke-width': m, opacity: c }).add(d.axisGroup));
      if (i && !isNaN(y))
        (i.xy = s = this.getLabelPosition(y, s, i, g, k, t, a, N)),
          (this.isFirst && !this.isLast && !p(e.showFirstLabel, 1)) || (this.isLast && !this.isFirst && !p(e.showLastLabel, 1))
            ? (ja = !1)
            : g && !d.isRadial && !k.step && !k.rotation && !b && c !== 0 && this.handleOverflow(s),
          N && a % N && (ja = !1),
          ja && !isNaN(s.y) ? ((s.opacity = c), i[this.isNew ? 'attr' : 'animate'](s), (this.isNew = !1)) : i.attr('y', -9999);
    },
    destroy: function () {
      Pa(this, this.axis);
    },
  ...
  z.PlotLineOrBand.prototype = {
    render: function () {
      var a = this,
        ...
        v = {},
        x = b.chart.renderer;
      b.isLog && ((i = Na(i)), (h = Na(h)), (k = Na(k)));
      if (g) {
        if (((o = b.getPlotLinePath(k, g)), (v = { stroke: r, 'stroke-width': g }), l)) v.dashstyle = l;
      } else if (j) {
      ...
      v.zIndex = A;
      if (m)
        if (o) m.show(), m.animate({ d: o });
        else {
          if ((m.hide(), f)) a.label = f = f.destroy();
        }
      else if (o && o.length && ((a.svgElem = m = x.path(o).attr(v).add()), n))
        ...
        n))
          d(q);
      e && t(e.text) && o && o.length && b.width > 0 && b.height > 0 && !o.flat
        ? ((e = C(
            {
              align: c && j && 'center',
              x: c ? !j && 4 : 10,
    ...
    renderLabel: function (a, b, c, d) {
      ...
      if (!e)
        (e = { align: a.textAlign || a.align, rotation: a.rotation }),
          (e.zIndex = d),
    ...
    destroy: function () {
      Aa(this.axis.plotLinesAndBands, this);
      delete this.axis;
      Pa(this);
    },
  };
  var F = (z.Axis = function () {
    this.init.apply(this, arguments);
  });
  F.prototype = {
    defaultOptions: {
    ...
    defaultYAxisOptions: {
      ...
      stackLabels: {
        ...
        style: C(V.line.dataLabels.style, { color: '#000000' }),
      },
    },
    ...
    init: function (a, b) {
      ...
      if (this.isLog) (this.val2lin = Na), (this.lin2val = za);
    },
    ...
    defaultLabelFormatter: function () {
      ...
      if (h) g = Ka(h, this);
        ...
        for (; f-- && g === u; )
          (c = Math.pow(1e3, f + 1)), a >= c && (b * 10) % c === 0 && e[f] !== null && (g = z.numberFormat(b / c, -1) + e[f]);
      g === u && (g = Q(b) >= 1e4 ? z.numberFormat(b, -1) : z.numberFormat(b, -1, u, ''));
      return g;
    },
    getSeriesExtremes: function () {
      ...
      n(a.series, function (c) {
        if (c.visible || !b.options.chart.ignoreHiddenSeries) {
          ...
          a.isLog && e <= 0 && (e = null);
          if (a.isXAxis) {
            if (((d = c.xData), d.length)) (a.dataMin = E(p(a.dataMin, d[0]), Oa(d))), (a.dataMax = s(p(a.dataMax, d[0]), Ea(d)));
          } else {
            c.getExtremes();
            f = c.dataMax;
            c = c.dataMin;
            if (t(c) && t(f)) (a.dataMin = E(p(a.dataMin, c), c)), (a.dataMax = s(p(a.dataMax, f), f));
    ...
    translate: function (a, b, c, d, e, f) {
      ...
      b
        ? ((a = a * h + i), (a -= k), (a = a / j + d), e && (a = g.lin2val(a)))
        : (e && (a = g.val2lin(a)), f === 'between' && (f = 0.5), (a = h * (a - d) * j + i + h * k + (ta(f) ? j * f * g.pointRange : 0)));
      return a;
    },
    ...
    getPlotLinePath: function (a, b, c, d, e) {
      ...
      isNaN(e)
        ? (m = !0)
        : this.horiz
        ? ((i = h), (j = k - this.bottom), (a = c = o(a, g, g + this.width)))
        : ((a = g), (c = l - this.right), (i = j = o(i, h, h + this.height)));
        ...
        if (
          (h
            ...
            : (n(b.series, function (a) {
                ...
                !a.noSharedTooltip && t(b) && (e = t(e) ? E(e, b) : b);
              }),
              n(b.series, function (a) {
                var c = i ? 1 : k ? p(a.options.pointRange, e, 0) : b.axisPointRange || 0,
                  a = a.options.pointPlacement;
                d = s(d, c);
                b.single || ((f = s(f, Da(a) ? 0 : c / 2)), (g = s(g, a === 'on' ? 0 : c)));
              })),
    ...
    setTickInterval: function (a) {
      ...
      h
        ? ((b.linkedParent = c[b.coll][d.linkedTo]),
          ...
          d.type !== b.linkedParent.options.type && ea(11, 1))
        : (!q && t(o) && (b.dataMin >= o ? ((r = o), (j = 0)) : b.dataMax <= o && ((A = o), (i = 0))),
          (b.min = p(T, r, b.dataMin)),
          (b.max = p(v, A, b.dataMax)));
      if (e) !a && E(b.min, p(b.dataMin, b.min)) <= 0 && ea(10, 1), (b.min = na(Na(b.min), 15)), (b.max = na(Na(b.max), 15));
      if (b.range && t(b.max)) (b.userMin = b.min = T = s(b.min, b.minFromRange())), (b.userMax = v = b.max), (b.range = null);
      b.beforePadding && b.beforePadding();
      b.adjustForMinRange();
      if (!m && !b.axisPointRange && !b.usePercentage && !h && t(b.min) && t(b.max) && (c = b.max - b.min))
        !t(T) && j && (b.min -= c * j), !t(v) && i && (b.max += c * i);
      if (ta(d.floor)) b.min = s(b.min, d.floor);
      if (ta(d.ceiling)) b.max = E(b.max, d.ceiling);
      if (q && t(b.dataMin))
        if (((o = o || 0), !t(T) && b.min < o && b.dataMin >= o)) b.min = o;
        else if (!t(v) && b.max > o && b.dataMax <= o) b.max = o;
      b.tickInterval =
        b.min === b.max || b.min === void 0 || b.max === void 0
          ? 1
          : h && !k && l === b.linkedParent.options.tickPixelInterval
          ? (k = b.linkedParent.tickInterval)
          : p(k, this.tickAmount ? (b.max - b.min) / s(this.tickAmount - 1, 1) : void 0, m ? 1 : ((b.max - b.min) * l) / s(b.len, l));
      g &&
        !a &&
        n(b.series, function (a) {
      ...
      if (b.pointRange && !k) b.tickInterval = s(b.pointRange, b.tickInterval);
      ...
      if (!f && !e && !k)
        b.tickInterval = Bb(
          ...
          null,
          Ab(b.tickInterval),
          p(d.allowDecimals, !(b.tickInterval > 0.5 && b.tickInterval < 5 && b.max > 1e3 && b.max < 9999)),
          !!this.tickAmount
        );
    ...
    setTickPositions: function () {
      ...
      if (!this.isLinked)
        this.trimTicks(b, e, f),
          this.min === this.max && t(this.min) && !this.tickAmount && ((g = !0), (this.min -= 0.5), (this.max += 0.5)),
          (this.single = g),
    ...
    alignToOthers: function () {
      ...
      this.chart.options.chart.alignTicks !== !1 &&
        c.alignTicks !== !1 &&
        n(this.chart[this.coll], function (c) {
          var e = c.options,
    ...
    getTickAmount: function () {
      ...
      !b && this.alignToOthers() && (b = Fa(this.len / c) + 1);
    ...
    adjustTickAmount: function () {
      var a = this.tickInterval,
        ...
        e = b && b.length;
      if (e < c) {
        for (; b.length < c; ) b.push(na(b[b.length - 1] + a));
        this.transA *= (e - 1) / (c - 1);
    ...
    getExtremes: function () {
      var a = this.isLog;
      return {
        min: a ? na(za(this.min)) : this.min,
        max: a ? na(za(this.max)) : this.max,
    ...
    getThreshold: function (a) {
      var b = this.isLog,
        c = b ? za(this.min) : this.min,
        b = b ? za(this.max) : this.max;
    ...
    unsquish: function () {
      ...
      c
        ? (l = !b.staggerLines && !b.step && (t(h) ? [h] : f < p(b.autoRotationLimit, 80) && b.autoRotation)) &&
          n(l, function (a) {
            var b;
            if (a === h || (a && a >= -90 && a <= 90))
              (j = m(Q(i.h / ia(oa * a)))), (b = j + Q(a / 360)), b < k && ((k = b), (g = a), (e = j));
          })
        : b.step || (e = m(i.h));
      this.autoRotation = l;
    ...
    renderUnsquish: function () {
      var a = this.chart,
        ...
        g = (this.slotWidth =
          (f && (e.step || 0) < 2 && !e.rotation && ((this.staggerLines || 1) * a.plotWidth) / h) ||
          (!f && ((g[3] && g[3] - a.spacing[3]) || a.chartWidth * 0.33))),
        i = s(1, y(g - 2 * (e.padding || 5))),
        j = {},
        ...
        o,
        q;
      if (!Da(e.rotation)) j.rotation = e.rotation || 0;
      if (this.autoRotation)
        n(c, function (a) {
          if ((a = d[a]) && a.labelLength > m) m = a.labelLength;
        }),
          m > i && m > h.h ? (j.rotation = this.labelRotation) : (this.labelRotation = 0);
      else if (g && ((l = { width: i + 'px' }), !k)) {
        l.textOverflow = 'clip';
        for (o = c.length; !f && o--; )
          if (((q = c[o]), (i = d[q].label)))
            if (
              (i.styles.textOverflow === 'ellipsis' && i.css({ textOverflow: 'clip' }),
              i.getBBox().height > this.len / c.length - (h.h - h.f) || d[q].labelLength > g)
            )
              i.specCss = { textOverflow: 'ellipsis' };
      }
      if (j.rotation && ((l = { width: (m > a.chartHeight * 0.5 ? a.chartHeight * 0.33 : a.chartHeight) + 'px' }), !k))
        l.textOverflow = 'ellipsis';
      if ((this.labelAlign = e.align || this.autoLabelAlign(this.labelRotation))) j.align = this.labelAlign;
      n(c, function (a) {
        var b = (a = d[a]) && a.label;
        if (b) b.attr(j), l && b.css(C(l, b.specCss)), delete b.specCss, (a.rotation = j.rotation);
      });
    ...
    getOffset: function () {
      ...
      if (j || a.isLinked) {
        if (
          (n(e, function (b) {
            f[b] ? f[b].addLabel() : (f[b] = new db(a, b));
          }),
          a.renderUnsquish(),
          r.reserveSpace !== !1 &&
            (h === 0 || h === 2 || { 1: 'left', 3: 'right' }[h] === a.labelAlign || a.labelAlign === 'center') &&
            n(e, function (a) {
              A = s(f[a].getLabelSize(), A);
            }),
          a.staggerLines)
        )
          (A *= a.staggerLines), (a.labelOffset = A * (a.opposite ? -1 : 1));
      } else for (N in f) f[N].destroy(), delete f[N];
        ...
        if (!a.axisTitle)
          (a.axisTitle = c
            ...
            .attr({
              ...
              align: q.textAlign || { low: T ? 'right' : 'left', middle: 'center', high: T ? 'left' : 'right' }[q.align],
            })
            .addClass('highcharts-' + this.coll.toLowerCase() + '-title')
            .css(q.style)
            .add(a.axisGroup)),
            (a.axisTitle.isNew = !0);
        if (k) (l = a.axisTitle.getBBox()[g ? 'height' : 'width']), (m = q.offset), (o = t(m) ? 0 : p(q.margin, g ? 5 : 10));
        a.axisTitle[k ? 'show' : 'hide'](!0);
      }
      a.offset = x * p(d.offset, v[h]);
      a.tickRotCorr = a.tickRotCorr || { x: 0, y: 0 };
      c = h === 2 ? a.tickRotCorr.y : 0;
      g = Math.abs(A) + o + (A && x * (g ? p(r.y, a.tickRotCorr.y + 8) : r.x) - c);
      a.axisTitleMargin = p(m, g);
      v[h] = s(v[h], a.axisTitleMargin + l + x * a.offset, g);
      d = d.offset ? 0 : U(d.lineWidth / 2) * 2;
      b[i] = s(b[i], d);
    },
    getLinePath: function (a) {
      ...
      return b.renderer.crispLine(
        ['M', e ? this.left : f, e ? d : this.top, 'L', e ? b.chartWidth - this.right : f, e ? d : b.chartHeight - this.bottom],
        a
      );
    },
    ...
    render: function () {
      var a = this,
        ...
        q = d.lineWidth,
        r,
        A = b.hasRendered && t(a.oldMin) && !isNaN(a.oldMin),
        p = a.showAxis,
        v = c.globalAnimation,
        x,
        N;
      ...
      if (a.hasData() || f) {
        a.minorTickInterval &&
          ...
          n(a.getMinorTickPositions(), function (b) {
            j[b] || (j[b] = new db(a, b, 'minor'));
            A && j[b].isNew && j[b].render(null, !0);
            j[b].render(null, !1, 1);
          });
        if (
          g.length &&
          (n(g, function (b, c) {
            if (!f || (b >= a.min && b <= a.max)) i[b] || (i[b] = new db(a, b)), A && i[b].isNew && i[b].render(c, !0, 0.1), i[b].render(c);
          }),
          o && (a.min === 0 || a.single))
        )
          i[-1] || (i[-1] = new db(a, -1, null, !0)), i[-1].render(-1);
        m &&
          n(g, function (c, d) {
            N = g[d + 1] !== u ? g[d + 1] + o : a.max - o;
            if (d % 2 === 0 && c < a.max && N <= a.max + (b.polar ? -o : o))
              k[c] || (k[c] = new z.PlotLineOrBand(a)),
                (x = c + o),
                (k[c].options = { from: e ? za(x) : x, to: e ? za(N) : N, color: m }),
                k[c].render(),
                (k[c].isActive = !0);
          });
        if (!a._addedPlotLB)
      ...
      if (q)
        (r = a.getLinePath(q)),
          a.axisLine
            ? a.axisLine.animate({ d: r })
            : (a.axisLine = c.path(r).attr({ stroke: d.lineColor, 'stroke-width': q, zIndex: 7 }).add(a.axisGroup)),
          a.axisLine[p ? 'show' : 'hide'](!0);
    ...
    drawCrosshair: function (a, b) {
      var c,
        ...
        e,
        f;
      if (!this.crosshair || (t(b) || !p(d.snap, !0)) === !1) this.hideCrosshair();
      else if (
        (p(d.snap, !0)
          ? t(b) && (c = this.isXAxis ? b.plotX : this.len - b.plotY)
          : (c = this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos),
        (c = this.isRadial
          ? this.getPlotLinePath(this.isXAxis ? b.x : p(b.stackY, b.y)) || null
          : this.getPlotLinePath(null, null, null, null, c) || null),
        c === null)
      )
        this.hideCrosshair();
      else if (((e = this.categories && !this.isRadial), (f = p(d.width, e ? this.transA : 1)), this.cross))
  ...
  w(F.prototype, {
    ...
    removePlotBandOrLine: function (a) {
      ...
      n([c.plotLines || [], d.plotLines || [], c.plotBands || [], d.plotBands || []], function (b) {
        for (e = b.length; e--; ) b[e].id === a && Aa(b, b[e]);
      });
    },
  });
  F.prototype.getTimeTicks = function (a, b, c, d) {
    var e = [],
      ...
      k = a.count;
    if (t(b)) {
      i[Qb](j >= H.second ? 0 : k * U(i.getMilliseconds() / k));
      if (j >= H.second) i[Rb](j >= H.minute ? 0 : k * U(i.getSeconds() / k));
      if (j >= H.minute) i[Sb](j >= H.hour ? 0 : k * U(i[Cb]() / k));
      if (j >= H.hour) i[Tb](j >= H.day ? 0 : k * U(i[Db]() / k));
      if (j >= H.day) i[Fb](j >= H.month ? 1 : k * U(i[ib]() / k));
      j >= H.month && (i[Gb](j >= H.year ? 0 : k * U(i[jb]() / k)), (h = i[kb]()));
      j >= H.year && ((h -= h % k), i[Hb](h));
      if (j === H.week) i[Fb](i[ib]() - i[Eb]() + p(d, 1));
      b = 1;
      if (zb || hb) (i = i.getTime()), (i = new da(i + gb(i)));
      h = i[kb]();
      for (
        var d = i.getTime(), l = i[jb](), m = i[ib](), o = !g || !!hb, q = (H.day + (g ? gb(i) : i.getTimezoneOffset() * 6e4)) % H.day;
        d < c;
        ...
        e.push(d),
          j === H.year
            ...
            ? (d = rb(h, l + b * k))
            : o && (j === H.day || j === H.week)
            ? (d = rb(h, l, m + b * k * (j === H.day ? 1 : 7)))
            : (d += j * k),
          b++;
      e.push(d);
      n(
        Sa(e, function (a) {
          return j <= H.hour && a % H.day === q;
        }),
        function (a) {
          f[a] = 'day';
        }
  ...
  F.prototype.normalizeTimeTickInterval = function (a, b) {
    ...
    c = Bb(a / e, f, d[0] === 'year' ? s(Ab(a / e), 1) : 1);
  ...
  F.prototype.getLogTickPositions = function (a, b, c, d) {
    ...
    if (a >= 0.5) (a = y(a)), (g = this.getLinearTickPositions(a, b, c));
    else if (a >= 0.08)
      for (
        var f = U(b), h, i, j, k, l, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9];
        f < c + 1 && !l;
        f++
      ) {
        i = e.length;
        for (h = 0; h < i && !l; h++) (j = Na(za(f) * e[h])), j > b && (!d || k <= c) && k !== u && g.push(k), k > c && (l = !0), (k = j);
      }
    else if (
      ((b = za(b)),
      (c = za(c)),
  ...
  Mb.prototype = {
    ...
    getPosition: function (a, b, c) {
      var d = this.chart,
        ...
        l = function (a, b, c, d, h, i) {
          ...
          else if (m) f[a] = s(h, d + g + c > b ? d : d + g);
          else return !1;
        },
        m = function (a, b, c, d) {
          var g;
        ...
        q = function () {
          l.apply(0, i) !== !1 ? m.apply(0, j) === !1 && !h && (o(!0), q()) : h ? (f.x = f.y = 0) : (o(!0), q());
        };
    ...
    refresh: function (a, b) {
      ...
      j === !1
        ...
        : (this.isHidden && (Ta(d), d.attr('opacity', 1).show()),
          ...
          (this.isHidden = !1));
      M(c, 'tooltipRefresh', { text: j, x: f + c.plotLeft, y: g + c.plotTop, borderColor: l });
    },
    ...
    getXDateFormat: function (a, b, c) {
      ...
      if (e) {
        ...
        for (f in H) {
          if (e === H.week && +la('%w', a.x) === c.options.startOfWeek && h.substr(6) === '00:00:00.000') {
            f = 'week';
            break;
          }
          if (H[f] > e) {
    ...
    tooltipFooterHeaderFormatter: function (a, b) {
      var c = b ? 'footer' : 'header',
        ...
        f = e.xDateFormat,
        g = d.xAxis,
        h = g && g.options.type === 'datetime' && ta(a.key),
        c = e[c + 'Format'];
  ...
  var ma;
  eb = B && B.documentElement.ontouchstart !== u;
  var ab = (z.Pointer = function (a, b) {
    this.init(a, b);
  });
  ab.prototype = {
    init: function (a, b) {
    ...
    normalize: function (a, b) {
      ...
      return w(a, { chartX: y(c), chartY: y(d) });
    },
    ...
    runPointActions: function (a) {
      ...
      g && (e ? g.noSharedTooltip : g.directTouch) && f
        ...
        : (n(c, function (b) {
            ...
            b.visible &&
              ...
              (m = b.searchPoint(a, !i && b.kdDimensions === 1)) &&
              k.push(m);
          }),
          n(k, function (a) {
            a &&
              n(['dist', 'distX'], function (b, c) {
                typeof a[b] === 'number' && a[b] < h[c] && ((h[c] = a[b]), (l[c] = a));
              });
          }));
      if (e) for (b = k.length; b--; ) (k[b].clientX !== l[1].clientX || k[b].series.noSharedTooltip) && k.splice(b, 1);
      if (l[0] && (l[0] !== this.prevKDPoint || (d && d.isHidden)))
        if (e && !l[0].series.noSharedTooltip)
          k.length && d && d.refresh(k, a),
            n(k, function (b) {
      ...
      if (!this._onDocumentMouseMove)
        (this._onDocumentMouseMove = function (a) {
          if ($[ma]) $[ma].pointer.onDocumentMouseMove(a);
        }),
          D(B, 'mousemove', this._onDocumentMouseMove);
      n(e ? k : [p(l[1], f)], function (b) {
        var c = b && b.series;
        c &&
          n(['xAxis', 'yAxis', 'colorAxis'], function (d) {
    ...
    drag: function (a) {
      ...
      if (!m || !m.touch)
        if (
          (d < h ? (d = h) : d > h + j && (d = h + j),
          e < i ? (e = i) : e > i + k && (e = i + k),
          (this.hasDragged = Math.sqrt(Math.pow(o - d, 2) + Math.pow(q - e, 2))),
          this.hasDragged > 10)
        ) {
          l = b.isInsidePlot(o - h, q - i);
          if (b.hasCartesianSeries && (this.zoomX || this.zoomY) && l && !r && !m)
            this.selectionMarker = m = b.renderer
              ...
              .add();
          m && f && ((d -= o), m.attr({ width: Q(d), x: (d > 0 ? 0 : d) + o }));
          m && g && ((d = e - q), m.attr({ height: Q(d), y: (d > 0 ? 0 : d) + q }));
    ...
    drop: function (a) {
        ...
        if (this.hasDragged || d)
          n(c.axes, function (c) {
            if (c.zoomEnabled && t(c.min) && (d || b[{ xAxis: 'zoomX', yAxis: 'zoomY' }[c.coll]])) {
              ...
              e[c.coll].push({ axis: c, min: E(q, f), max: s(q, f) });
              k = !0;
            }
          }),
            k &&
      ...
      if (c)
        I(c.container, { cursor: c._cursor }),
    ...
    onContainerMouseMove: function (a) {
      var b = this.chart;
      if (!t(ma) || !$[ma] || !$[ma].mouseIsDown) ma = b.index;
      a = this.normalize(a);
      a.returnValue = !1;
    ...
    onContainerClick: function (a) {
      ...
      b.cancelClick ||
        (c && this.inClass(a.target, 'highcharts-tracker')
          ? (M(c.series, 'click', w(a, { point: c })), b.hoverPoint && c.firePointEvent('click', a))
          : (w(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && M(b, 'click', a)));
    },
    setDOMEvents: function () {
      ...
      mb === 1 && D(B, 'mouseup', a.onDocumentMouseUp);
      if (eb)
        (b.ontouchstart = function (b) {
          ...
          mb === 1 && D(B, 'touchend', a.onDocumentTouchEnd);
    },
    destroy: function () {
      var a;
      R(this.chart.container, 'mouseleave', this.onContainerMouseLeave);
      mb || (R(B, 'mouseup', this.onDocumentMouseUp), R(B, 'touchend', this.onDocumentTouchEnd));
      clearInterval(this.tooltipTimeout);
      for (a in this) this[a] = null;
    },
  };
  w(z.Pointer.prototype, {
    ...
    pinchTranslateDirection: function (a, b, c, d, e, f, g, h) {
      var i = this.chart,
        ...
        u,
        c = function () {
          !x && Q(N - t) > 20 && (A = h || Q(s - y) / Q(N - t));
          r = (o - s) / A + N;
          q = i['plot' + (a ? 'Width' : 'Height')] / A;
        };
      c();
      b = r;
      b < n.min ? ((b = n.min), (u = !0)) : b + q > n.max && ((b = n.max - q), (u = !0));
      u ? ((s -= 0.8 * (s - g[j][0])), x || (y -= 0.8 * (y - g[j][1])), c()) : (g[j] = [s, y]);
      p || ((f[j] = r - o), (f[m] = q));
      f = p ? 1 / A : A;
      e[m] = q;
      e[j] = b;
      d[p ? (a ? 'scaleY' : 'scaleX') : 'scale' + k] = A;
      d['translate' + k] = f * o + (s - f * N);
    },
    pinch: function (a) {
      var b = this,
        c = b.chart,
      ...
      if (a.type === 'touchstart')
        ...
        if (!i) b.selectionMarker = i = w({ destroy: qa, touch: !0 }, c.plotBox);
  ...
  if (J.PointerEvent || J.MSPointerEvent) {
    var Ga = {},
      ...
      Ob = function (a, b, c, d) {
        if ((a.pointerType === 'touch' || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && $[ma])
          d(a), (d = $[ma].pointer), d[b]({ type: c, target: a.currentTarget, preventDefault: qa, touches: bc() });
      };
    w(ab.prototype, {
      ...
      batchMSEvents: function (a) {
        ...
        a(B, Nb ? 'pointerup' : 'MSPointerUp', this.onDocumentPointerUp);
      },
    });
  ...
  vb.prototype = {
    init: function (a, b) {
      ...
      if (b.enabled)
        (c.itemStyle = d),
          (c.itemHiddenStyle = C(d, b.itemHiddenStyle)),
          (c.itemMarginTop = e),
    ...
    renderItem: function (a) {
      ...
      if (!A) {
        ...
        a.legendItem = A = c
          .text('', l ? f + g : -g, this.baseline || 0, x)
          .css(C(a.visible ? h : i))
          .attr({ align: l ? 'left' : 'right', zIndex: 2 })
          .add(a.legendGroup);
        if (!this.baseline)
          (this.fontMetrics = c.fontMetrics(h.fontSize, A)), (this.baseline = this.fontMetrics.f + 3 + q), A.attr('y', this.baseline);
        n.drawLegendSymbol(this, a);
        this.setItemEvents && this.setItemEvents(a, A, x, h, i);
      ...
      this.offsetWidth = m || s((e ? this.itemX - r - k : f) + j, this.offsetWidth);
    },
    getAllItems: function () {
      var a = [];
      n(this.chart.series, function (b) {
        var c = b.options;
        if (p(c.showInLegend, !t(c.linkedTo) ? u : !1, !0)) a = a.concat(b.legendItems || (c.legendType === 'point' ? b.data : b));
      });
      return a;
    },
    adjustMargins: function (a, b) {
      ...
      this.display &&
        !d.floating &&
        n([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/], function (f, g) {
          f.test(e) &&
            !t(a[g]) &&
            (c[ub[g]] = s(
              c[ub[g]],
              c.legend[(g + 1) % 2 ? 'legendHeight' : 'legendWidth'] + [1, -1, -1, 1][g] * d[g % 2 ? 'x' : 'y'] + p(d.margin, 12) + b[g]
            ));
        });
    },
    render: function () {
        ...
        if (i) {
          ...
          (a.box = i =
            c
              ...
              .attr({ stroke: j.borderColor, 'stroke-width': l || 0, fill: m || 'none' })
              .add(d)
              .shadow(j.shadow)),
            (i.isNew = !0);
        i[f ? 'show' : 'hide']();
      ...
      f && d.align(w({ width: g, height: h }, j), !0, 'spacingBox');
    ...
    handleOverflow: function (a) {
      ...
      o.length = 0;
      if (a > f) {
        this.clipHeight = h = s(f - 20 - this.titleHeight - q, 0);
        this.currentPage = p(this.currentPage, 1);
        this.fullHeight = a;
        n(A, function (a, b) {
          var c = a._legendItemPos[1],
            d = y(a.legendItem.getBBox().height),
            e = o.length;
          if (!e || (c - o[e - 1] > h && (r || c) !== o[e - 1])) o.push(r || c), e++;
          b === A.length - 1 && c + d - o[e - 1] > h && o.push(c);
          c !== r && (r = c);
        });
        ...
        b.scroll(0);
        a = f;
      } else if (m) T(c.chartHeight), m.hide(), this.scrollGroup.attr({ translateY: 1 }), (this.clipHeight = 0);
      return a;
    },
    scroll: function (a, b) {
      var c = this.pages,
  ...
  Z = z.LegendSymbolMixin = {
    ...
    drawLineMarker: function (a) {
      var b = this.options,
        ...
        f = this.legendGroup,
        a = a.baseline - y(a.fontMetrics.b * 0.3),
        g;
      if (b.lineWidth) {
  ...
  (/Trident\/7\.0/.test(La) || Za) &&
    S(vb.prototype, 'positionItem', function (a, b) {
      var c = this,
        d = function () {
  ...
  Ca.prototype = {
    ...
    getArgs: function () {
      var a = [].slice.call(arguments);
      if (Da(a[0]) || a[0].nodeName) this.renderTo = a.shift();
      this.init(a[0], a[1]);
    },
    init: function (a, b) {
      var c,
      ...
      f.xAxis = [];
      f.yAxis = [];
      f.animation = pa ? !1 : p(d.animation, !0);
      f.pointCount = f.colorCounter = f.symbolCounter = 0;
      f.firstRender();
    },
    initSeries: function (a) {
      var b = this.options.chart;
      (b = K[a.type || b.type || b.defaultSeriesType]) || ea(17, !0);
      b = new b();
      b.init(this, a);
      return b;
    },
      ...
      i &&
        ...
        n(b, function (a) {
          ...
          if (a.extKey !== b)
            (a.extKey = b),
              q.push(function () {
                M(a, 'afterSetExtremes', w(a.eventArgs, a.getExtremes()));
                delete a.eventArgs;
              });
          (j || g) && a.redraw();
        }));
    ...
    layOutTitles: function (a) {
      ...
      if (
        c &&
        (c.css({ width: (f.width || h) + 'px' }).align(w({ y: g.fontMetrics(f.style.fontSize, c).b - 3 }, f), !1, 'spacingBox'),
        !f.floating && !f.verticalAlign)
      )
        b = c.getBBox().height;
      d &&
        (d
          .css({ width: (e.width || h) + 'px' })
          .align(w({ y: b + (f.margin - 13) + g.fontMetrics(e.style.fontSize, c).b }, e), !1, 'spacingBox'),
        !e.floating && !e.verticalAlign && (b = Fa(b + d.getBBox().height)));
    ...
    getChartSize: function () {
      ...
      if (!t(b)) this.containerWidth = wa(c, 'width');
      if (!t(a)) this.containerHeight = wa(c, 'height');
    ...
    cloneRenderTo: function (a) {
      var b = this.renderToClone,
        c = this.container;
      a
        ? b && (this.renderTo.appendChild(c), Xa(b), delete this.renderToClone)
    ...
    getContainer: function () {
      ...
      a || ea(13, !0);
      d = G(W(a, 'data-highcharts-chart'));
      !isNaN(d) && $[d] && $[d].hasRendered && $[d].destroy();
      ...
      this.renderer = new (z[c.renderer] || $a)(a, d, e, c.style, c.forExport, b.exporting && b.exporting.allowHTML);
      pa && this.renderer.create(this, a, d, e);
    ...
    getMargins: function (a) {
      var b = this.spacing,
        ...
        d = this.titleOffset;
      this.resetMargins();
      if (d && !t(c[0])) this.plotTop = s(this.plotTop, d + this.options.title.margin + b[0]);
    ...
    reflow: function (a) {
      var b = this,
        c = b.options.chart,
        d = b.renderTo,
        e = c.width || wa(d, 'width'),
        f = c.height || wa(d, 'height'),
        c = a ? a.target : J;
      if (!b.hasUserSize && !b.isPrinting && e && f && (c === J || c === B)) {
    ...
    setSize: function (a, b, c) {
      ...
      if (t(a)) (d.chartWidth = e = s(0, y(a))), (d.hasUserSize = !!e);
      if (t(b)) d.chartHeight = f = s(0, y(b));
      a = g.globalAnimation;
      (a ? fb : I)(d.container, { width: e + 'px', height: f + 'px' }, a);
      d.setChartSize(!0);
      g.setSize(e, f, c);
      d.maxTicks = null;
      n(d.axes, function (a) {
    ...
    setChartSize: function (a) {
      ...
      this.plotWidth = k = s(0, y(d - i - this.marginRight));
      this.plotHeight = l = s(0, y(e - j - this.marginBottom));
      ...
      b = Fa(s(d, h[3]) / 2);
      c = Fa(s(d, h[0]) / 2);
      this.clipBox = { x: b, y: c, width: U(this.plotSizeX - s(d, h[1]) / 2 - b), height: s(0, U(this.plotSizeY - s(d, h[2]) / 2 - c)) };
      a ||
    ...
    drawChartBox: function () {
      ...
      if (k) f ? f.animate(n) : (this.plotBackground = b.rect(q, r, A, p, 0).attr({ fill: k }).add().shadow(a.plotShadow));
      if (l) h ? h.animate(n) : (this.plotBGImage = b.image(l, q, r, A, p).add());
      x ? x.animate({ width: s.width, height: s.height }) : (this.clipRect = b.clipRect(s));
      if (m)
        g
          ? ((g.strokeWidth = -m), g.animate(g.crisp({ x: q, y: r, width: A, height: p })))
          : (this.plotBorder = b
              .rect(q, r, A, p, 0, -m)
              .attr({ stroke: a.plotBorderColor, 'stroke-width': m, fill: 'none', zIndex: 1 })
              .add());
      this.isDirtyBox = !1;
    },
    ...
    showCredits: function (a) {
      if (a.enabled && !this.credits)
        this.credits = this.renderer
          .text(a.text, 0, 0)
          .on('click', function () {
            if (a.href) J.location.href = a.href;
          })
    ...
    destroy: function () {
      ...
      if (d) (d.innerHTML = ''), R(d), f && Xa(d);
      for (e in a) delete a[e];
    },
    isReadyToRender: function () {
      var a = this;
      return (!ha && J == J.top && B.readyState !== 'complete') || (pa && !J.canvg)
        ? (pa
            ? Xb.push(function () {
                a.firstRender();
    ...
    firstRender: function () {
      ...
      if (a.isReadyToRender()) {
        ...
        a.linkSeries();
        M(a, 'beforeRender');
        if (z.Pointer) a.pointer = new ab(a, b);
        a.render();
        a.renderer.draw();
  ...
  Ha.prototype = {
    init: function (a, b, c) {
      ...
      if (
        ...
        ((b = a.options.colors || a.chart.options.colors), (this.color = this.color || b[a.colorCounter++]), a.colorCounter === b.length)
      )
        a.colorCounter = 0;
      a.chart.pointCount++;
      return this;
    ...
    destroy: function () {
      var a = this.series.chart,
        ...
        c;
      a.pointCount--;
      if (b && (this.setState(), Aa(b, this), !b.length)) a.hoverPoints = null;
  ...
  P.prototype = {
    ...
    autoIncrement: function () {
      ...
      if (d === 'month' || d === 'year') (a = new da(b)), (a = d === 'month' ? +a[Gb](a[jb]() + c) : +a[Hb](a[kb]() + c)), (c = a - b);
      this.xIncrement = b + c;
      return b;
    },
    setOptions: function (a) {
      ...
      this.tooltipOptions = C(
        O.tooltip,
        O.plotOptions[this.type].tooltip,
        b.tooltip,
    ...
    getColor: function () {
      this.options.colorByPoint
        ...
        : this.getCyclic('color', this.options.color || V[this.type].color, this.chart.options.colors);
    },
    getSymbol: function () {
      ...
      if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible)
        ...
        if (o && h > o) {
          ...
          if (ta(k)) {
            ...
            for (c = 0; c < h; c++) (q[c] = m), (r[c] = a[c]), (m += k);
            e.xIncrement = m;
          } else if (Ma(k))
            if (A) for (c = 0; c < h; c++) (k = a[c]), (q[c] = k[0]), (r[c] = k.slice(1, A + 1));
            else for (c = 0; c < h; c++) (k = a[c]), (q[c] = k[0]), (r[c] = k[1]);
          else ea(12);
        } else
          for (c = 0; c < h; c++)
            if (
              a[c] !== u &&
              ((k = { series: e }), e.pointClass.prototype.applyOptions.apply(k, [a[c]]), e.updateParallelArrays(k, c), m && t(k.name))
            )
              l.names[k.x] = k.name;
        Da(r[0]) && ea(14, !0);
        e.data = [];
    ...
    processData: function (a) {
      ...
      if (h) (a = h.getExtremes()), (o = a.min), (q = a.max);
      if (l && this.sorted && !k && (!i || d > i || this.forceCrop))
        if (b[d - 1] < o || b[0] > q) (b = []), (c = []);
        else if (b[0] < o || b[d - 1] > q)
          (e = this.cropData(this.xData, this.yData, o, q)), (b = e.xData), (c = e.yData), (e = e.start), (f = !0);
      for (i = b.length || 1; --i; )
        (d = m ? j(b[i]) - j(b[i - 1]) : b[i] - b[i - 1]), d > 0 && (g === u || d < g) ? (g = d) : d < 0 && this.requireSorting && ea(15);
      this.cropped = f;
      this.cropStart = e;
    ...
    generatePoints: function () {
      ...
      for (m = 0; m < g; m++)
        (i = h + m),
          j
            ? (l[m] = new f().init(this, [d[m]].concat(ua(e[m]))))
            : (b[i] ? (k = b[i]) : a[i] !== u && (b[i] = k = new f().init(this, a[i], d[m])), (l[m] = k)),
          (l[m].index = i);
      if (b && (g !== (c = b.length) || j))
        for (m = 0; m < c; m++) if ((m === h && !j && (m += g), b[m])) b[m].destroyElements(), (b[m].plotX = u);
      this.data = b;
      this.points = l;
    },
    getExtremes: function (a) {
      ...
      for (l = 0; l < d; l++)
        if (
          ((j = c[l]),
          (k = a[l]),
          (i = k !== null && k !== u && (!b.isLog || k.length || k > 0)),
          (j =
            this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || ((c[l + 1] || j) >= g && (c[l - 1] || j) <= h)),
          i && j)
        )
    ...
    translate: function () {
      ...
      for (
        ...
        var n = f[a],
          ...
          x = n.y;
        o = n.low;
        var N = b && e.stacks[(this.negStacks && x < (l ? 0 : k) ? '-' : '') + this.stackKey];
        if (e.isLog && x !== null && x <= 0) (n.y = x = null), ea(10);
        n.plotX = m = E(s(-1e5, c.translate(v, 0, 0, 0, 1, i, this.type === 'flags')), 1e5);
        if (b && this.visible && !n.isNull && N && N[v])
          (r = this.getStackIndicator(r, v, this.index)),
            (N = N[v]),
            (x = N.points[r.key]),
            (o = x[0]),
            (x = x[1]),
            o === l && (o = p(k, e.min)),
            e.isLog && o <= 0 && (o = null),
            (n.total = n.stackTotal = N.total),
            (n.percentage = N.total && (n.y / N.total) * 100),
            (n.stackY = x),
            N.setOffset(this.pointXOffset || 0, this.barW || 0);
        n.yBottom = t(o) ? e.translate(o, 0, 1, 0, 1) : null;
        h && (x = this.modifyValue(x, n));
        n.plotY = o = typeof x === 'number' && x !== Infinity ? E(s(-1e5, e.translate(x, 0, 1, 0, 1)), 1e5) : u;
        n.isInside = o !== u && o >= 0 && o <= e.len && m >= 0 && m <= c.len;
        n.clientX = j ? c.translate(v, 0, 0, 0, 1) : m;
        n.negative = n.y < (k || 0);
    ...
    getValidPoints: function (a) {
      return Sa(a || this.points, function (a) {
        return !a.isNull;
      });
    },
    setClip: function (a) {
      ...
      if (l.enabled !== !1 || this._hasPointMarkers)
        for (f = b.length; f--; )
          if (
            ...
            (o = g.marker || {}),
            (q = !!g.marker),
            (a = (s && o.enabled === u) || o.enabled),
            (r = g.isInside),
            a && e !== u && !isNaN(e) && g.y !== null)
          )
            if (
              ((a = g.pointAttr[g.selected ? 'select' : ''] || m),
              (h = a.r),
              ...
              k[r ? 'show' : 'hide'](!0)
                .attr(a)
                .animate(w({ x: d - h, y: e - h }, k.symbolName ? { width: 2 * h, height: 2 * h } : {}));
            else {
              if (r && (h > 0 || j))
                g.graphic = c.renderer
                  .symbol(i, d - h, e - h, 2 * h, 2 * h, q ? o : l)
                  .attr(a)
                  .add(n);
            }
    ...
    getAttribs: function () {
      ...
      if (!k || g < k || j)
        for (; g--; ) {
          ...
          if (r.length) {
            j = 0;
            for (f = r[j]; k[A] >= f.value; ) f = r[++j];
            k.color = k.fillColor = p(f.color, a.color);
          }
          j = b.colorByPoint || k.color;
          if (k.options) for (s in m) t(c[m[s]]) && (j = !0);
          if (j) {
            c = c || {};
            j = [];
            d = c.states || {};
            ...
            if (!b.marker || (k.negative && !f.fillColor && !e.fillColor))
              f[a.pointAttrToOptions.fill] =
                f.color ||
                (!k.options.color && e[k.negative && h ? 'negativeColor' : 'color']) ||
                va(k.color)
    ...
    destroy: function () {
      ...
      n(a.axisTypes || [], function (b) {
        if ((h = a[b])) Aa(h.series, a), (h.isDirty = h.forceRedraw = !0);
      });
    ...
    getGraphPath: function (a, b, c) {
      ...
      n(a, function (g, k) {
        var l = g.plotX,
          m = g.plotY,
          o = a[k - 1];
        if ((g.leftCliff || (o && o.rightCliff)) && !c) i = !0;
        g.isNull && !t(b) && k > 0
          ? (i = !e.connectNulls)
          : g.isNull && !b
          ? (i = !0)
          : (k === 0 || i
              ? (o = ['M', g.plotX, g.plotY])
              : d.getPointSpline
              ? (o = d.getPointSpline(a, g, k))
              : f
              ? ((o =
                  f === 1 ? ['L', o.plotX, m] : f === 2 ? ['L', (o.plotX + l) / 2, o.plotY, 'L', (o.plotX + l) / 2, m] : ['L', l, o.plotY]),
                o.push('L', l, m))
              : (o = ['L', l, m]),
            h.push.apply(h, o),
            (i = !1));
    ...
    drawGraph: function () {
      ...
      n(c, function (c, i) {
        ...
        if (k) k.animate({ d: f });
          ...
          (k = { stroke: c[1], 'stroke-width': d, fill: g, zIndex: 1 }),
    ...
    applyZones: function () {
      var a = this,
        ...
        v,
        x = !1;
      if (d.length && (i || j) && l.min !== u)
        i && i.hide(),
          j && j.hide(),
          (m = l.getExtremes()),
          n(d, function (d, n) {
            e = o ? (r ? b.plotWidth : 0) : r ? 0 : l.toPixels(m.min);
            e = E(s(p(f, e), 0), k);
            f = E(s(y(l.toPixels(p(d.value, m.max), !0)), 0), k);
            x && (e = f = l.toPixels(m.max));
            A = Math.abs(e - f);
            T = E(e, f);
            v = s(e, f);
            if (l.isXAxis) {
              if (((h = { x: q ? v : T, y: 0, width: A, height: k }), !r)) h.x = b.plotHeight - h.x;
            } else if (((h = { x: 0, y: q ? v : T, width: k, height: A }), r)) h.y = b.plotWidth - h.y;
            b.inverted &&
              c.isVML &&
              (h = l.isXAxis
                ? { x: 0, y: o ? T : v, height: h.width, width: b.chartWidth }
    ...
    searchKDTree: function (a, b) {
      function c(a, b, j, k) {
        var l = b.point,
          ...
          q,
          r = l;
        q = t(a[e]) && t(l[e]) ? Math.pow(a[e] - l[e], 2) : null;
        o = t(a[f]) && t(l[f]) ? Math.pow(a[f] - l[f], 2) : null;
        o = (q || 0) + (o || 0);
        l.dist = t(o) ? Math.sqrt(o) : Number.MAX_VALUE;
        l.distX = t(q) ? Math.sqrt(q) : Number.MAX_VALUE;
        m = a[m] - l[m];
        o = m < 0 ? 'left' : 'right';
        q = m < 0 ? 'right' : 'left';
        b[o] && ((o = c(a, b[o], j + 1, k)), (r = o[g] < r[g] ? o : l));
        b[q] && Math.sqrt(m * m) < r[g] && ((a = c(a, b[q], j + 1, k)), (r = a[g] < r[g] ? a : r));
        return r;
      }
      var d = this,
  ...
  Ca.prototype.getStacks = function () {
    var a = this;
  ...
  P.prototype.setStackedPoints = function () {
    if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
      ...
      for (v = 0; v < d; v++) {
        x = a[v];
        t = b[v];
        q = this.getStackIndicator(q, x, this.index);
        T = q.key;
        n = (r = k && t < (g ? 0 : f)) ? j : i;
        m[n] || (m[n] = {});
        if (!m[n][x])
          o[n] && o[n][x] ? ((m[n][x] = o[n][x]), (m[n][x].total = null)) : (m[n][x] = new Ub(l, l.options.stackLabels, r, x, h));
        n = m[n][x];
        if (t !== null)
          (n.points[T] = n.points[this.index] = [p(n.cum, g)]),
            (n.touched = l.stacksTouched),
            q.index > 0 && this.singleStacks === !1 && (n.points[T][0] = n.points[this.index + ',' + x + ',0'][0]);
        e === 'percent'
          ? ((r = r ? i : j),
            k && m[r] && m[r][x]
              ? ((r = m[r][x]), (n.total = r.total = s(r.total, n.total) + Q(t) || 0))
              : (n.total = na(n.total + (Q(t) || 0))))
          : (n.total = na(n.total + (t || 0)));
        n.cum = p(n.cum, g) + (t || 0);
        t !== null && n.points[T].push(n.cum);
        c[v] = n.cum;
      }
    ...
    n([b, '-' + b], function (b) {
      ...
      for (var g = d.length, h, i; g--; )
        if (((h = d[g]), (e = a.getStackIndicator(e, h, a.index)), (f = (i = c[b] && c[b][h]) && i.points[e.key]), (h = f)))
          (i = i.total ? 100 / i.total : 0), (h[0] = na(h[0] * i)), (h[1] = na(h[1] * i)), (a.stackedYData[g] = h[1]);
    });
  };
  ...
  w(Ca.prototype, {
    ...
    addAxis: function (a, b, c, d) {
      var e = b ? 'xAxis' : 'yAxis',
        f = this.options;
      new F(this, C(a, { index: this[e].length, isX: b }));
      f[e] = ua(f[e] || {});
      f[e].push(a);
      p(c, !0) && this.redraw(d);
    },
    showLoading: function (a) {
      var b = this,
        ...
        e = c.loading,
        f = function () {
          d && I(d, { left: b.plotLeft + 'px', top: b.plotTop + 'px', width: b.plotWidth + 'px', height: b.plotHeight + 'px' });
        };
      if (!d)
        (b.loadingDiv = d = ca(Ya, { className: 'highcharts-loading' }, w(e.style, { zIndex: 10, display: 'none' }), b.container)),
          (b.loadingSpan = ca('span', null, e.labelStyle, d)),
          D(b, 'redraw', f);
      b.loadingSpan.innerHTML = a || c.lang.loading;
      if (!b.loadingShown)
        I(d, { opacity: 0, display: '' }), fb(d, { opacity: e.style.opacity }, { duration: e.showDuration || 0 }), (b.loadingShown = !0);
      f();
    },
  ...
  w(Ha.prototype, {
    update: function (a, b, c, d) {
      function e() {
        ...
        k.data[i] = fa(k.data[i]) ? f.options : a;
  ...
  w(P.prototype, {
    addPoint: function (a, b, c, d) {
      ...
      m = i.x;
      d = q.length;
      if (e.requireSorting && m < q[d - 1]) for (o = !0; d && q[d - 1] > m; ) d--;
  ...
  var Ia = ka(P);
  K.line = Ia;
  V.area = C(ba, { softThreshold: !1, threshold: 0 });
  var ya = ka(P, {
    type: 'area',
    singleStacks: !1,
    getStackPoints: function () {
      ...
      if (this.options.stacking) {
        ...
        for (o in e) e[o].total !== null && b.push(+o);
        b.sort(function (a, b) {
          return a - b;
        });
        k = sa(i, function () {
          ...
          if (f[g] && !f[g].isNull)
            a.push(f[g]),
              n([-1, 1], function (a) {
                ...
                if (o)
                  for (m = h; m >= 0 && m < j; )
                    (p = o.points[m]), p || (m === h ? (f[g][c] = !0) : k[m] && (v = e[g].points[m]) && (d -= v[1] - v[0])), (m += l);
            ...
            o = d.toPixels(o, !0);
            a.push({ isNull: !0, plotX: c.toPixels(g, !0), plotY: o, yBottom: o });
          }
        });
      }
      return a;
      ...
      var b = P.prototype.getGraphPath,
        ...
        r = function (b, c, f) {
          var g = a[b],
            ...
            n,
            g = !0;
          f || q ? ((r = (q ? b[0] : b[1]) + f), (n = b[0] + f), (g = !!q)) : !d && a[c] && a[c].isNull && (r = n = m);
          r !== void 0 &&
            (i.push({ plotX: k, plotY: r === null ? o : e.toPixels(r, !0), isNull: g }),
            h.push({ plotX: k, plotY: n === null ? o : e.toPixels(n, !0) }));
        },
        a = a || this.points;
      d && (a = this.getStackPoints());
      for (f = 0; f < a.length; f++)
        if (((g = a[f].isNull), (k = p(a[f].rectPlotX, a[f].plotX)), (q = p(a[f].yBottom, o)), !g || c)) {
          c || r(f, f - 1, 'left');
          if (!g || d || !c) i.push(a[f]), h.push({ x: f, plotX: k, plotY: q });
          c || r(f, f + 1, 'right');
        }
      f = b.call(this, i, !0, !0);
      h.reversed = !0;
    ...
    drawGraph: function () {
      ...
      n(d, function (d) {
        ...
        g
          ? g.animate({ d: b })
          : ((g = { fill: d[2] || d[1], zIndex: 0 }),
            d[2] || (g['fill-opacity'] = p(c.fillOpacity, 0.75)),
  ...
  Ia = ka(P, {
    ...
    getPointSpline: function (a, b, c) {
      ...
      if (f && !f.isNull && c && !c.isNull) {
        ...
        h += k;
        j += k;
        h > a && h > e ? ((h = s(a, e)), (j = 2 * e - h)) : h < a && h < e && ((h = E(a, e)), (j = 2 * e - h));
        j > c && j > e ? ((j = s(c, e)), (h = 2 * e - j)) : j < c && j < e && ((j = E(c, e)), (h = 2 * e - j));
        b.rightContX = i;
        b.rightContY = j;
      }
  ...
  Ia = ka(P, {
      ...
      b.grouping === !1
        ...
        : n(a.chart.series, function (b) {
            ...
            if (b.type === a.type && b.visible && d.len === e.len && d.pos === e.pos)
              c.stacking ? ((f = b.stackKey), g[f] === u && (g[f] = h++), (i = g[f])) : c.grouping !== !1 && (i = h++), (b.columnIndex = i);
          });
      var i = E(Q(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange || c.tickInterval || 1), c.len),
        j = i * b.groupPadding,
        k = (i - 2 * j) / h,
        b = E(b.maxPointWidth || c.len, p(b.pointWidth, k * (1 - 2 * b.pointPadding)));
    ...
    translate: function () {
      ...
      n(a.points, function (c) {
        ...
        Q(v) < g &&
          g &&
          ((v = g), (t = (!e.reversed && !c.negative) || (e.reversed && c.negative)), (n = Q(n - f) > g ? d - g : f - (t ? g : 0)));
        c.barX = q;
        c.pointWidth = i;
        c.tooltipPos = b.inverted ? [e.len + e.pos - b.plotLeft - h, a.xAxis.len - q - r / 2, v] : [q + r / 2, h + e.pos - b.plotTop, v];
        c.shapeType = 'rect';
        c.shapeArgs = a.crispCol(q, n, r, v);
      });
    },
    getSymbol: qa,
    drawLegendSymbol: Z.drawRectangle,
    ...
    drawPoints: function () {
      ...
      n(a.points, function (h) {
        ...
        if (i !== u && !isNaN(i) && h.y !== null)
          (f = h.shapeArgs),
            (i = t(a.borderWidth) ? { 'stroke-width': a.borderWidth } : {}),
            (g = h.pointAttr[h.selected ? 'select' : ''] || a.pointAttr['']),
            j
              ? (Ta(j), j.attr(i).attr(g)[b.pointCount < e ? 'animate' : 'attr'](C(f)))
    ...
    animate: function (a) {
      ...
      if (ha)
        a
          ? ((e.scaleY = 0.001),
            (a = E(b.pos + b.len, s(b.pos, b.toPixels(c.threshold)))),
  ...
  ba = {
    ...
    pointClass: ka(Ha, {
      ...
      setVisible: function (a, b) {
        var c = this,
          ...
          b = p(b, f);
        if (a !== c.visible) {
          c.visible = c.options.visible = a = a === u ? !c.visible : a;
    ...
    translate: function (a) {
      ...
      var b = 0,
        ...
        h,
        i = c.startAngle || 0,
        j = (this.startAngleRad = (Ba / 180) * (i - 90)),
        i = (this.endAngleRad = (Ba / 180) * (p(c.endAngle, i + 360) - 90)) - j,
        k = this.points,
      ...
      for (m = 0; m < o; m++) {
        ...
        g = j + b * i;
        q.shapeType = 'arc';
        q.shapeArgs = { x: a[0], y: a[1], r: a[2] / 2, innerR: a[3] / 2, start: y(f * 1e3) / 1e3, end: y(g * 1e3) / 1e3 };
        h = (g + f) / 2;
        h > 1.5 * Ba ? (h -= 2 * Ba) : h < -Ba / 2 && (h += 2 * Ba);
        q.slicedTranslation = { translateX: y(aa(h) * d), translateY: y(ia(h) * d) };
        f = (aa(h) * a[2]) / 2;
        g = (ia(h) * a[2]) / 2;
        q.tooltipPos = [a[0] + f * 0.7, a[1] + g * 0.7];
        q.half = h < -Ba / 2 || h > Ba / 2 ? 1 : 0;
        q.angle = h;
        e = E(e, l / 2);
        q.labelPos = [
          a[0] + f + aa(h) * l,
    ...
    drawPoints: function () {
      ...
      n(a.points, function (j) {
        if (j.y !== null) {
          ...
          f && f.attr(c);
          if (d) d.setRadialReference(a.center).attr(g).animate(w(h, c));
          else {
        ...
        n(e, function (e) {
          ...
          if (o && !h) e.dataLabel = o.destroy();
            ...
            if (o)
              ...
              if (v.color === 'contrast')
                x.color = d.inside || d.distance < 0 || b.stacking ? k.getContrast(e.color || a.color) : '#000000';
              if (c) x.cursor = c;
              for (r in o) o[r] === u && delete o[r];
              o = e.dataLabel = k[h ? 'text' : 'label'](i, 0, -9999, d.shape, null, null, d.useHTML)
                .attr(o)
                .css(w(v, x))
                .add(j)
                .shadow(d.shadow);
  ...
  P.prototype.alignDataLabel = function (a, b, c, d, e) {
    var f = this.chart,
      ...
      l = c.rotation,
      m = c.align,
      o = this.visible && (a.series.forceDL || f.isInsidePlot(h, y(i), g) || (d && f.isInsidePlot(h, g ? d.x + 1 : d.y + d.height - 1, g))),
      q = p(c.overflow, 'justify') === 'justify';
    if (o)
      (d = w({ x: g ? f.plotWidth - i : h, y: y(g ? f.plotHeight - h : i), width: 0, height: 0 }, d)),
        w(c, { width: j.width, height: j.height }),
        l
          ? ((q = !1),
            ...
            m === 'left'
              ? (g.y -= h ? j.height : 0)
              : m === 'center'
              ? ((g.x -= j.width / 2), (g.y -= j.height / 2))
              : m === 'right' && ((g.x -= j.width), (g.y -= h ? 0 : j.height)))
          : (b.align(c, null, d), (g = b.alignAttr)),
        q
          ? this.justifyDataLabel(b, c, g, j, d, e)
          : p(c.crop, !0) && (o = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + j.width, g.y + j.height)),
        c.shape && !l && b.attr({ anchorX: a.plotX, anchorY: a.plotY });
    if (!o) Ta(b), b.attr({ y: -9999 }), (b.placed = !1);
  };
  ...
  if (K.pie)
    (K.pie.prototype.drawDataLabels = function () {
      ...
      if (a.visible && (e.enabled || a._hasPointLabels)) {
        ...
        n(b, function (a) {
          if (a.dataLabel && a.visible) u[a.half].push(a), (a.dataLabel._pos = null);
        });
        for (B = 2; B--; ) {
          var G = [],
            K = [],
            ...
            H;
          if (F) {
            a.sortByAngle(I, B - 0.5);
            for (L = b = 0; !b && I[L]; ) (b = I[L] && I[L].dataLabel && (I[L].dataLabel.getBBox().height || 21)), L++;
            if (m > 0) {
              v = E(r + q + m, d.plotHeight);
              for (L = s(0, r - q - m); L <= v; L += b) G.push(L);
              v = G.length;
              if (F > v) {
                c = [].concat(I);
                c.sort(J);
                for (L = F; L--; ) c[L].rank = L;
                for (L = F; L--; ) I[L].rank >= v && I.splice(L, 1);
                F = I.length;
              }
              for (L = 0; L < F; L++) {
                c = I[L];
                ...
                c = 9999;
                var M, O;
                for (O = 0; O < v; O++) (M = Q(G[O] - x[1])), M < c && ((c = M), (H = O));
                if (H < L && G[L] !== null) H = L;
                else for (v < F - L + H && G[L] !== null && (H = v - F + L); G[H] === null; ) H++;
                K.push({ i: H, y: G[H] });
                G[H] = null;
              }
              K.sort(J);
            ...
            for (L = 0; L < F; L++) {
              ...
              c = x[1];
              if (m > 0) {
                if (((v = K.pop()), (H = v.i), (z = v.y), (c > z && G[H + 1] !== null) || (c < z && G[H - 1] !== null)))
                  z = E(s(0, c), d.plotHeight);
              } else z = c;
              w = e.justify ? o[0] + (B ? -1 : 1) * (q + m) : a.getX(z === r - q - m || z === r + q + m ? c : z, B);
              t._attr = { visibility: C, align: x[6] };
              t._pos = { x: w + e.x + ({ left: f, right: -f }[x[6]] || 0), y: z + e.y - 10 };
              t.connX = w;
              t.connY = z;
              if (this.options.size === null)
                (v = t.width),
                  w - v < f ? (D[3] = s(y(v - w + f), D[3])) : w + v > h - f && (D[1] = s(y(w + v - h + f), D[1])),
                  z - b / 2 < 0 ? (D[0] = s(y(-z + b / 2), D[0])) : z + b / 2 > i && (D[2] = s(y(z + b / 2 - i), D[2]));
            }
          }
        }
        if (Ea(D) === 0 || this.verifyDataLabelOverflow(D))
            ...
            A &&
              ...
              n(this.points, function (b) {
                ...
                if ((t = b.dataLabel) && t._pos && b.visible)
                  (C = t._attr.visibility),
                    (w = t.connX),
                    (z = t.connY),
                    (k = l
                      ? ['M', w + (x[6] === 'left' ? 5 : -5), z, 'C', w, z, 2 * x[2] - x[4], 2 * x[3] - x[5], x[2], x[3], 'L', x[4], x[5]]
                      : ['M', w + (x[6] === 'left' ? 5 : -5), z, 'L', x[2], x[3], 'L', x[4], x[5]]),
                    j
                      ? (j.animate({ d: k }), j.attr('visibility', C))
                      : (b.connector = j =
                          a.chart.renderer
                            .path(k)
                            .attr({ 'stroke-width': g, stroke: e.connectorColor || b.color || '#606060', visibility: C })
      ...
      (K.pie.prototype.alignDataLabel = qa),
        ...
        for (d = e + 1; d < b; ++d)
          if (
            ...
            j &&
              ...
              (l = !(
                m.x + q.translateX > l.x + o.translateX + (j.width - r) ||
                m.x + q.translateX + (k.width - r) < l.x + o.translateX ||
                m.y + q.translateY > l.y + o.translateY + (j.height - r) ||
                m.y + q.translateY + (k.height - r) < l.y + o.translateY
              ))))
          )
  ...
  var ob = (z.TrackerMixin = {
    ...
    drawTrackerGraph: function () {
      var a = this,
        ...
        o = 'rgba(192,192,192,' + (ha ? 1.0e-4 : 0.002) + ')';
      if (e && !c)
        for (k = e + 1; k--; )
          d[k] === 'M' && d.splice(k + 1, 0, d[k + 1] - i, d[k + 2], 'L'),
            ((k && d[k] === 'M') || k === e) && d.splice(k, 0, 'L', d[k - 2] + i, d[k - 1]);
      j
        ? j.attr({ d: d })
        : ((a.tracker = h
            .path(d)
          ...
          n([a.tracker, a.markerGroup], function (a) {
            a.addClass('highcharts-tracker')
              ...
              .css(l);
            if (eb) a.on('touchstart', m);
          }));
    },
  });
  if (K.column) Ia.prototype.drawTracker = ob.drawTrackerPoint;
  if (K.pie) K.pie.prototype.drawTracker = ob.drawTrackerPoint;
  if (K.scatter) ya.prototype.drawTracker = ob.drawTrackerPoint;
  w(vb.prototype, {
    ...
    pan: function (a, b) {
      ...
      n(b === 'xy' ? [1, 0] : [1], function (b) {
        var b = c[b ? 'xAxis' : 'yAxis'][0],
          ...
          i = i > h;
        if (b.series.length && (i || l > E(k.dataMin, k.min)) && (!i || j < s(k.dataMax, k.max)))
  ...
  w(Ha.prototype, {
    ...
    onMouseOver: function (a, b) {
      ...
      if (
        this.series &&
        (this.firePointEvent('mouseOver'), e && (!e.shared || c.noSharedTooltip) && e.refresh(this, a), this.setState('hover'), !b)
      )
        d.hoverPoint = this;
    },
    onMouseOut: function () {
    ...
    setState: function (a, b) {
      ...
      if (
        ...
        if (this.graphic)
          (g = g && this.graphic.symbolName && q.r),
            this.graphic.attr(C(q, g ? { x: c - g, y: d - g, width: 2 * g, height: 2 * g } : {})),
            k && k.hide();
        else {
          if (a && i)
        ...
        if ((c = f[a] && f[a].halo) && c.size) {
          ...
          o.attr(w({ fill: this.color || e.color, 'fill-opacity': c.opacity, zIndex: -1 }, c.attributes))[b ? 'animate' : 'attr']({
  ...
  w(P.prototype, {
    ...
    setState: function (a) {
      ...
      if (
        this.state !== a &&
        ((this.state = a),
        !(d[a] && d[a].enabled === !1) && (a && (e = d[a].lineWidth || e + (d[a].lineWidthPlus || 0)), c && !c.dashstyle))
      ) {
        a = { 'stroke-width': e };
  ...
  S(F.prototype, 'getTimeTicks', function (a, b, c, d, e, f, g, h) {
    var i = 0,
      j,
      k,
      l = {},
    ...
    if ((!this.options.ordinal && !this.options.breaks) || !f || f.length < 3 || c === u) return a.call(this, b, c, d, e);
    o = f.length;
    for (j = 0; j < o; j++) {
      q = j && f[j - 1] > d;
      f[j] < c && (i = j);
    ...
    if (h && a.unitRange <= H.hour) {
      j = r.length - 1;
      for (i = 1; i < j; i++) la('%d', r[i]) !== la('%d', r[i - 1]) && ((l[r[i]] = 'day'), (m = !0));
      m && (l[r[0]] = 'day');
      a.higherRanks = l;
    }
    r.info = a;
    if (h && t(p)) {
      ...
      j = [];
      var v;
      for (m = []; h--; ) (i = this.translate(r[h])), v && (m[h] = v - i), (j[h] = v = i);
      m.sort();
      m = m[U(m.length / 2)];
      m < p * 0.6 && (m = null);
      h = r[a - 1] > d ? a - 1 : a;
      for (v = void 0; h--; )
        (i = j[h]),
          (d = v - i),
          v && d < p * 0.8 && (m === null || d < m * 0.8)
            ? (l[r[h]] && !l[r[h + 1]] ? ((d = h + 1), (v = i)) : (d = h), r.splice(d, 1))
            : (v = i);
    }
    return r;
  });
  w(F.prototype, {
    beforeSetTickPositions: function () {
      ...
      if ((e = this.options.ordinal) || i) {
        ...
        c
          ? ((this.ordinalPositions = b),
            (d = this.val2lin(s(f, b[0]), !0)),
            (h = s(this.val2lin(E(g, b[b.length - 1]), !0), 1)),
            (this.ordinalSlope = g = (g - f) / (h - d)),
            (this.ordinalOffset = f - d * g))
          : (this.ordinalPositions = this.ordinalSlope = this.ordinalOffset = u);
      }
      this.isOrdinal = e && c;
    ...
    lin2val: function (a, b) {
      ...
      if (c) {
        var d = this.ordinalSlope,
          ...
          g,
          h;
        if (b) a < 0 ? (a = c[0]) : a > f ? (a = c[f]) : ((f = U(a)), (h = a - f));
        else
          for (; f--; )
            if (((g = d * f + e), a >= g)) {
              d = d * (f + 1) + e;
        ...
        c = h !== u && c[f] !== u ? c[f] + (h ? h * (c[f + 1] - c[f]) : 0) : a;
      } else c = a;
      return c;
    },
      ...
      if (!c[d])
        (f = {
          ...
          n(this.series, function (c) {
            g = { xAxis: f, xData: c.xData, chart: a, destroyGroupedData: qa };
            g.options = {
              dataGrouping: b ? { enabled: !0, forced: !0, approximation: 'open', units: [[b.unitName, [b.count]]] } : { enabled: !1 },
            };
      ...
      if (m.ordinalPositions) {
        if (Q(f) > 1)
          k &&
            ...
            f.min >= E(g.dataMin, i) && f.max <= s(h, j) && c.setExtremes(f.min, f.max, !0, !1, { trigger: 'pan' }),
            (this.mouseDownX = d),
  ...
  P.prototype.gappedPath = function () {
    var a = this.options.gapSize,
      ...
      c = this.points.slice(),
      d = c.length - 1;
    if (a && d > 0) for (; d--; ) c[d + 1].x - c[d].x > b.closestPointRange * a && c.splice(d + 1, 0, { isNull: !0 });
  ...
  (function (a) {
      ...
      if (this.options.breaks) {
        ...
        this.setAxisTranslation = function (a) {
          ...
          for (l in b)
            (g = b[l]),
              (f = g.repeat || Infinity),
              d.isInBreak(g, k) && (k += (g.to % f) - (k % f)),
              d.isInBreak(g, j) && (j -= (j % f) - (g.from % f));
          for (l in b) {
            g = b[l];
            m = g.from;
            for (f = g.repeat || Infinity; m - f > k; ) m -= f;
            for (; m < k; ) m += f;
            for (; m < j; m += f) a.push({ value: m, move: 'in' }), a.push({ value: m + (g.to - g.from), move: 'out', size: g.breakSize });
          }
          a.sort(function (a, b) {
          ...
          for (l in a) {
            g = a[l];
            b += g.move === 'in' ? 1 : -1;
            if (b === 1 && g.move === 'in') m = g.value;
            b === 0 && (c.push({ from: m, to: g.value, len: g.value - m - (g.size || 0) }), (e += g.value - m - (g.size || 0)));
          }
          d.breakArray = c;
          h(d, 'afterBreaks');
    ...
    a.Series.prototype.drawBreaks = function () {
      ...
      f(['y', 'x'], function (n) {
        ...
        f(b, function (a) {
          j = d(a['stack' + n.toUpperCase()], a[n]);
          f(e, function (b) {
            i = !1;
            if ((g < b.from && j > b.to) || (g > b.from && j < b.from)) i = 'pointBreak';
            else if ((g < b.from && j > b.from && j < b.to) || (g > b.from && j > b.to && j < b.from)) i = 'pointInBreak';
  ...
  var ga = P.prototype,
    ...
    Va = {
      ...
      open: function (a) {
        return a.length ? a[0] : a.hasNulls ? null : u;
      },
      high: function (a) {
        return a.length ? Ea(a) : a.hasNulls ? null : u;
      },
      low: function (a) {
        return a.length ? Oa(a) : a.hasNulls ? null : u;
      },
      close: function (a) {
        return a.length ? a[a.length - 1] : a.hasNulls ? null : u;
      },
  ...
  ga.groupData = function (a, b, c, d) {
    ...
    for (; n <= i; n++) {
      for (; (c[1] !== u && a[n] >= c[1]) || n === i; )
        if (
          ((j = c.shift()),
          (k = d.apply(0, m)),
          k !== u && (g.push(j), h.push(k)),
          (m[0] = []),
          (m[1] = []),
          (m[2] = []),
          (m[3] = []),
      ...
      if (o) {
        ...
        var p;
        for (k = 0; k < q; k++)
          if (((p = j[o[k]]), typeof p === 'number')) m[k].push(p);
    ...
    if (dc.apply(this, arguments) !== !1 && c) {
      ...
      if (i) {
        ...
        var j = a.getExtremes(),
          ...
          g = ((i * (j - c)) / g) * h,
          i = a.getTimeTicks(
            a.normalizeTimeTickInterval(g, b.units || Zb),
            Math.min(c, e[0]),
            Math.max(j, e[e.length - 1]),
            a.options.startOfWeek,
            e,
            this.closestPointRange
          ),
          f = ga.groupData.apply(this, [e, f, i, b.approximation]),
          e = f[0],
          f = f[1];
        if (b.smoothed) {
          b = e.length - 1;
          for (e[b] = Math.min(e[b], j); b-- && b > 0; ) e[b] += g / 2;
          e[0] = Math.max(e[0], c);
        }
        this.currentDataGrouping = i.info;
        this.closestPointRange = i.info.totalRange;
        if (t(e[0]) && e[0] < a.dataMin) {
  ...
  ga.destroyGroupedData = function () {
  ...
  S(Mb.prototype, 'tooltipFooterHeaderFormatter', function (a, b, c) {
    var d = b.series,
      ...
      h,
      i = d.xAxis;
    return i && i.options.type === 'datetime' && f && ta(b.key)
      ? ((a = d.currentDataGrouping),
        (f = f.dateTimeLabelFormats),
        a ? ((i = f[a.unitName]), a.count === 1 ? (g = i[0]) : ((g = i[1]), (h = i[2]))) : !g && f && (g = this.getXDateFormat(b, e, i)),
        (g = la(g, b.key)),
        h && (g += la(h, b.key + a.totalRange - 1)),
        Ka(e[(c ? 'footer' : 'header') + 'Format'], { point: w(b, { key: g }), series: d }))
      : a.call(this, b, c);
  });
  ga.destroy = function () {
  ...
  S(F.prototype, 'setScale', function (a) {
    a.call(this);
    n(this.series, function (a) {
      a.hasProcessed = !1;
    });
  ...
  F.prototype.setDataGrouping = function (a, b) {
    ...
    if (this instanceof F) for (c = this.series.length; c--; ) this.series[c].update({ dataGrouping: a }, !1);
    else
      n(
      ...
      n(a.points, function (k) {
        if (k.plotY !== u)
          (i = k.graphic),
            ...
            (j = y(k.plotX) - f),
            (g = y(k.shapeArgs.width / 2)),
            (h = ['M', j, y(k.yBottom), 'L', j, y(k.plotY)]),
            k.open !== null && ((d = y(k.plotOpen) + f), h.push('M', j, d, 'L', j - g, d)),
            k.close !== null && ((e = y(k.plotClose) + f), h.push('M', j, e, 'L', j + g, e)),
            i ? i.attr(c).animate({ d: h }) : (k.graphic = b.renderer.path(h).attr(c).add(a.group));
      });
    },
    animate: null,
  });
  K.ohlc = ba;
  V.candlestick = C(V.column, {
    lineColor: 'black',
    lineWidth: 1,
  ...
  ba = ka(ba, {
    ...
    drawPoints: function () {
      ...
      n(a.points, function (n) {
        m = n.graphic;
        if (n.plotY !== u)
          (c = n.pointAttr[n.selected ? 'selected' : ''] || d),
            ...
            m ? m.attr(c).animate({ d: o }) : (n.graphic = b.renderer.path(o).attr(c).add(a.group).shadow(a.options.shadow));
      });
    },
  });
  K.candlestick = ba;
  var wb = xa.prototype.symbols;
  V.flags = C(V.column, {
    fillColor: 'white',
    lineWidth: 1,
    pointRange: 0,
  ...
  K.flags = ka(K.column, {
    ...
    translate: function () {
      ...
      if (e && e.visible && i) {
        ...
        for (a = 'plot' + a[0].toUpperCase() + a.substr(1); i-- && c[d]; )
          if (((e = c[d]), (l = h[i]), l.x <= e.x && l[a] !== void 0)) {
            if (e.x <= m)
              (e.plotY = l[a]), l.x < e.x && !g && (o = h[i + 1]) && o[a] !== u && (e.plotY += ((e.x - l.x) / (o.x - l.x)) * (o[a] - l[a]));
            d--;
            i++;
            if (d < 0) break;
          }
      ...
      n(c, function (a, d) {
        ...
        if (a.plotY === u)
          a.x >= k.min && a.x <= k.max
            ? (a.plotY = b.chartHeight - j.bottom - (j.opposite ? j.height : 0) + j.offset - b.plotTop)
            : (a.shapeArgs = {});
        if ((f = c[d - 1]) && f.plotX === a.plotX) {
          if (f.stackIndex === u) f.stackIndex = 0;
          e = f.stackIndex + 1;
        }
        a.stackIndex = e;
      });
    ...
    drawPoints: function () {
      ...
      for (j = c.length; j--; )
        if (
          ...
          (e = k.plotX),
          e > 0 && (e -= p(k.lineWidth, g.lineWidth) % 2),
          (l = k.stackIndex),
          (i = k.options.shape || g.shape),
          (f = k.plotY),
          f !== u && (f = k.plotY + h - (l !== u && l * g.stackDistance)),
          (m = l ? u : k.plotX),
          (o = l ? u : k.plotY),
          (l = k.graphic),
          f !== u && e >= 0 && !a)
          ...
          (a = k.pointAttr[k.selected ? 'select' : ''] || b),
            l
              ? l.attr({ x: e, y: f, r: a.r, anchorX: m, anchorY: o })
              : (k.graphic = d
                  .label(k.options.title || g.title || 'A', e, f, i, m, o, g.useHTML)
                  .css(C(g.style, k.style))
                  .attr(a)
                  .attr({ align: i === 'flag' ? 'left' : 'center', width: g.width, height: g.height })
    ...
    drawTracker: function () {
      ...
      n(a, function (b) {
        var c = b.graphic;
        c &&
          D(c.element, 'mouseover', function () {
  ...
  $a === z.VMLRenderer &&
    n(['flag', 'circlepin', 'squarepin'], function (a) {
      nb.prototype.symbols[a] = wb[a];
    });
  var ba = [].concat(Zb),
    xb = function (a) {
      var b = Sa(arguments, function (a) {
        return typeof a === 'number';
      });
  ...
  w(O, {
    navigator: {
      ...
      outlineWidth: 1,
      series: {
        type: K.areaspline === u ? 'line' : 'areaspline',
        color: '#4572A7',
        compare: null,
        fillOpacity: 0.05,
        dataGrouping: { approximation: 'average', enabled: !0, groupPixelWidth: 2, smoothed: !0, units: ba },
  ...
  Ib.prototype = {
    drawHandle: function (a, b) {
      ...
      this.rendered ||
        ((f[b] = d
          .g('navigator-handle-' + ['left', 'right'][b])
    ...
    drawScrollbarButton: function (a) {
      var b = this.chart.renderer,
        ...
        g;
      this.rendered ||
        ((d[a] = b.g().add(this.scrollbarGroup)),
        (g = b
          .rect(-0.5, -0.5, e + 1, e + 1, f.buttonBorderRadius, f.buttonBorderWidth)
          .attr({ stroke: f.buttonBorderColor, 'stroke-width': f.buttonBorderWidth, fill: f.buttonBackgroundColor })
          .add(d[a])),
        c.push(g),
        (g = b
          .path(['M', e / 2 + (a ? -1 : 1), e / 2 - 3, 'L', e / 2 + (a ? -1 : 1), e / 2 + 3, e / 2 + (a ? 2 : -2), e / 2])
          .attr({ fill: f.buttonArrowColor })
          .add(d[a])),
        c.push(g));
    ...
    render: function (a, b, c, d) {
      var e = this.chart,
        ...
        F = w + B,
        J;
      if (t(a) && !(isNaN(a) || (this.hasDragged && !t(c)))) {
        ...
        l.getExtremes &&
          (J = this.getUnionExtremes(!0)) &&
          (J.dataMin !== l.min || J.dataMax !== l.max) &&
          l.setExtremes(J.dataMin, J.dataMax, !0, !1);
        c = p(c, l.translate(a));
        d = p(d, l.translate(b));
        if (isNaN(c) || Q(c) === Infinity) (c = 0), (d = j);
        if (!(l.translate(d, !0) - l.translate(c, !0) < e.xAxis[0].minRange)) {
          this.zoomedMax = E(s(c, d, 0), h);
          this.zoomedMin = s(this.fixedWidth ? this.zoomedMax - this.fixedWidth : E(c, d), 0);
          ...
          if (!this.rendered) {
            if (z)
              (this.navigatorGroup = l = f.g('navigator').attr({ zIndex: 3 }).add()),
                (this.leftShade = f.rect().attr({ fill: A.maskFill }).add(l)),
                A.maskInside ? this.leftShade.css({ cursor: 'ew-resize' }) : (this.rightShade = f.rect().attr({ fill: A.maskFill }).add(l)),
                (this.outline = f.path().attr({ 'stroke-width': C, stroke: A.outlineColor }).add(l));
            if (r)
              (this.scrollbarGroup = k = f.g('scrollbar').add()),
                (m = u.trackBorderWidth),
                (this.scrollbarTrack = o =
                  f
                    .rect()
                    .attr({
                      x: 0,
                      y: (-m % 2) / 2,
                      fill: u.trackBackgroundColor,
                      stroke: u.trackBorderColor,
                      'stroke-width': m,
                      r: u.trackBorderRadius || 0,
                      height: n,
                    })
                    .add(k)),
                (this.scrollbar = m =
                  f
                    .rect()
                    .attr({ y: (-H % 2) / 2, height: n, fill: u.barBackgroundColor, stroke: u.barBorderColor, 'stroke-width': H, r: I })
                    .add(k)),
                (this.scrollbarRifles = f.path().attr({ stroke: u.rifleColor, 'stroke-width': 1 }).add(k));
          }
          e = e.isResizing ? 'animate' : 'attr';
          if (z) {
            this.leftShade[e](A.maskInside ? { x: g + b, y: w, width: c - b, height: x } : { x: g, y: w, width: b, height: x });
            if (this.rightShade) this.rightShade[e]({ x: g + c, y: w, width: h - c, height: x });
            this.outline[e]({
              d: ['M', i, F, 'L', g + b - B, F, g + b - B, F + G, 'L', g + c - B, F + G, 'L', g + c - B, F, i + j, F].concat(
                A.maskInside ? ['M', g + b + B, F, 'L', g + c - B, F] : []
              ),
            });
          ...
          if (r && k)
            this.drawScrollbarButton(0),
              ...
              k[e]({ translateX: i, translateY: y(F + x) }),
              o[e]({ width: j }),
              (g = n + b),
              (h = a - H),
              h < v && ((D = (v - h) / 2), (h = v), (g -= D)),
              (this.scrollbarPad = D),
              m[e]({ x: U(g) + (H % 2) / 2, width: h }),
              (v = n + b + a / 2 - 0.5),
              this.scrollbarRifles
                .attr({ visibility: a > 12 ? 'visible' : 'hidden' })
                [e]({
                  d: [
                    'M',
                    v - 3,
    ...
    addEvents: function () {
      ...
      eb && e.push([a, 'touchstart', b], [a, 'touchmove', c], [B, 'touchend', d]);
      n(e, function (a) {
        D.apply(null, a);
      });
      this._events = e;
    ...
    init: function () {
      ...
      a.mouseDownHandler = function (d) {
        var d = b.pointer.normalize(d),
          ...
          z = lb ? 10 : 7;
        if (y > h && y < h + g + k)
          if ((h = !a.scrollbarEnabled || y < h + g) && X.abs(u - e - n) < z)
            (a.grabbedLeft = !0), (a.otherHandlePos = f), (a.fixedExtreme = d.max), (b.fixedRange = null);
          else if (h && X.abs(u - f - n) < z)
            (a.grabbedRight = !0), (a.otherHandlePos = e), (a.fixedExtreme = d.min), (b.fixedRange = null);
          else if (u > n + e - t && u < n + f + t) (a.grabbedCenter = u), (a.fixedWidth = s), (i = u - e);
          else if (u > j && u < j + l) {
            f = h ? u - n - s / 2 : u < n ? e - s * 0.2 : u > j + l - k ? e + s * 0.2 : u < n + e ? e - s : f;
            if (f < 0) f = 0;
            else if (f + s >= p) (f = p - s), (w = a.getUnionExtremes().dataMax);
            if (f !== e)
              (a.fixedWidth = s), (e = c.toFixedRange(f, f + s, null, w)), d.setExtremes(e.min, e.max, !0, !1, { trigger: 'navigator' });
          }
      };
      a.mouseMoveHandler = function (c) {
        ...
        if (!c.touches || c.touches[0].pageX !== 0)
          (c = b.pointer.normalize(c)),
            (j = c.chartX),
            j < e ? (j = e) : j > g + h - d && (j = g + h - d),
            a.grabbedLeft
              ? ((l = !0), a.render(0, 0, j - e, a.otherHandlePos))
              : a.grabbedRight
              ? ((l = !0), a.render(0, 0, a.otherHandlePos, j - e))
              : a.grabbedCenter && ((l = !0), j < i ? (j = i) : j > f + i - k && (j = f + i - k), a.render(0, 0, j - i, j - i + k)),
            l &&
              a.scrollbarOptions.liveRedraw &&
              setTimeout(function () {
                a.mouseUpHandler(c);
              }, 0),
            (a.hasDragged = l);
      ...
      a.mouseUpHandler = function (d) {
        ...
        if (a.hasDragged) {
          ...
          t(e.min) && b.xAxis[0].setExtremes(e.min, e.max, !0, !1, { trigger: 'navigator', triggerOp: 'navigator-drag', DOMEvent: d });
        }
        if (d.type !== 'mousemove')
      ...
      a.navigatorEnabled
        ? ((a.xAxis = c =
            new F(
              b,
              C({ breaks: j && j.xAxis.options.breaks, ordinal: j && j.xAxis.options.ordinal }, f.xAxis, {
                id: 'navigator-x-axis',
                isX: !0,
                type: 'datetime',
                index: k,
          ...
          (a.yAxis = d = new F(b, C(f.yAxis, { id: 'navigator-y-axis', alignTicks: !1, height: g, offset: 0, index: l, zoomEnabled: !1 }))),
          j || f.series.data
            ? a.addBaseSeries()
            : b.series.length === 0 &&
              S(b, 'redraw', function (c, d) {
        ...
        : (a.xAxis = c =
            {
              translate: function (a, c) {
                var d = b.xAxis[0],
                  f = d.getExtremes(),
                  g = b.plotWidth - 2 * e,
                  h = xb('min', d.options.min, f.dataMin),
                  d = xb('max', d.options.max, f.dataMax) - h;
      ...
      S(b, 'getMargins', function (b) {
        ...
        a.top = h =
          a.navigatorOptions.top ||
          this.chartHeight -
            a.height -
            a.scrollbarHeight -
            this.spacing[2] -
            (f.verticalAlign === 'bottom' && f.enabled && !f.floating ? e.legendHeight + p(f.margin, 10) : 0);
    ...
    getUnionExtremes: function (a) {
      ...
      if (!a || b.dataMin !== null)
        f = {
          dataMin: p(d && d.min, xb('min', e.min, b.dataMin, c.dataMin)),
          dataMax: p(d && d.max, xb('max', e.max, b.dataMax, c.dataMax)),
        };
      return f;
    },
    ...
    addBaseSeries: function () {
      ...
      if (a && this.navigatorOptions.adaptToUpdatedData !== !1)
        D(a, 'updatedData', this.updatedDataHandler),
          (a.userOptions.events = w(a.userOptions.event, { updatedData: this.updatedDataHandler }));
    },
    updatedDataHandler: function () {
      ...
      i && ((l = g), (k = l + h));
      j && ((k = d), i || (l = s(k - h, o.xData[0])));
      n && (i || j)
        ? isNaN(l) || c.setExtremes(l, k, !0, !1, { trigger: 'updatedData' })
        : (m && this.chart.redraw(!1), a.render(s(e, g), E(f, d)));
    },
    destroy: function () {
      this.removeEvents();
      n(
  ...
  z.Scroller = Ib;
  S(F.prototype, 'zoom', function (a, b, c) {
    var d = this.chart,
      e = d.options,
      f = e.chart.zoomType,
      g = e.navigator,
    ...
    return h !== u ? h : a.call(this, b, c);
  });
  S(Ca.prototype, 'init', function (a, b, c) {
  ...
  S(P.prototype, 'addPoint', function (a, b, c, d, e) {
    ...
    f && this.xData.length > f && fa(b) && !Ma(b) && this.chart.scroller && ea(20, !0);
    a.call(this, b, c, d, e);
  });
  w(O, {
    rangeSelector: {
  ...
  O.lang = C(O.lang, { rangeSelectorZoom: 'Zoom', rangeSelectorFrom: 'From', rangeSelectorTo: 'To' });
  Jb.prototype = {
    clickButton: function (a, b) {
      ...
      if (!(j === null || k === null || a === c.selected)) {
        e.fixedRange = i;
        if (v) (this.forcedDataGrouping = !0), F.prototype.setDataGrouping.call(h || { chart: this.chart }, v, !1);
        if (o === 'month' || o === 'year')
          if (h) {
            if (((o = { range: g, max: m, dataMin: j, dataMax: k }), (l = h.minFromRange.call(o)), typeof o.newMax === 'number'))
              m = o.newMax;
          } else i = g;
        else if (i) (l = s(m - i, j)), (m = E(l + i, k));
        else if (o === 'ytd')
          if (h) {
            if (k === u)
              (j = Number.MAX_VALUE),
                (k = Number.MIN_VALUE),
                n(e.series, function (a) {
                  a = a.xData;
                  j = E(a[0], j);
                  k = s(a[a.length - 1], k);
                }),
        ...
        h
          ? (h.setExtremes(l, m, p(b, 1), 0, { trigger: 'rangeSelectorButton', rangeSelectorButton: g }), c.setSelected(a))
          : ((q = e.options.xAxis[0]),
            (w = q.range),
            (q.range = i),
            (t = q.min),
    ...
    init: function (a) {
      ...
      e !== u && d[e] && this.clickButton(e, !1);
      D(a, 'load', function () {
        D(a.xAxis[0], 'setExtremes', function (c) {
          this.max - this.min !== a.fixedRange &&
            c.trigger !== 'rangeSelectorButton' &&
            c.trigger !== 'updatedData' &&
    ...
    updateButtonStates: function (a) {
      ...
      n(b.buttonOptions, function (a, e) {
        var m = y(d.max - d.min),
          ...
          t = o > g - f,
          s = o < d.minRange,
          v = a.type === 'all' && d.max - d.min >= g - f && j[e].state !== 2,
          u = a.type === 'ytd' && la('%Y', f) === la('%Y', g),
          w = c.renderer.forExport && e === h,
          o = o === m,
          z = !d.hasVisibleSeries;
        if ((n === 'month' || n === 'year') && m >= { month: 28, year: 365 }[n] * 864e5 * p && m <= { month: 31, year: 366 }[n] * 864e5 * p)
          o = !0;
        w || (o && e !== h && e === b.lastSelected)
          ? (b.setSelected(e), j[e].setState(2))
          : !i && (t || s || v || u || z)
          ? j[e].setState(3)
          : j[e].state === 3 && j[e].setState(0);
      });
    },
    ...
    setInputValue: function (a, b) {
      ...
      this[a + 'Input'].value = la(c.inputEditDateFormat || '%Y-%m-%d', this[a + 'Input'].HCTime);
      this[a + 'DateBox'].attr({ text: la(c.inputDateFormat || '%b %e, %Y', this[a + 'Input'].HCTime) });
    },
    ...
    hideInput: function (a) {
      I(this[a + 'Input'], { border: 0, width: '1px', height: '1px' });
    ...
    drawInput: function (a) {
      var b = this,
        ...
        k = this.inputGroup;
      this[a + 'Label'] = j = e
        .label(O.lang[h ? 'rangeSelectorFrom' : 'rangeSelectorTo'], this.inputGroup.offset)
        .attr({ padding: 2 })
        .css(C(d, f.labelStyle))
        .add(k);
      k.offset += j.width + 5;
      this[a + 'DateBox'] = e = e
        .label('', k.offset)
        ...
        .css(C({ textAlign: 'center', color: '#444' }, d, f.inputStyle))
        .on('click', function () {
          b.showInput(a);
          b[a + 'Input'].focus();
        })
      ...
      i.onchange = function () {
        var a = i.value,
          d = (f.inputDateParser || da.parse)(a),
          e = c.xAxis[0],
          g = e.dataMin,
          j = e.dataMax;
        isNaN(d) && ((d = a.split('-')), (d = da.UTC(G(d[0]), G(d[1]) - 1, G(d[2]))));
        isNaN(d) ||
          (O.global.useUTC || (d += new da().getTimezoneOffset() * 6e4),
          h ? (d > b.maxInput.HCTime ? (d = u) : d < g && (d = g)) : d < b.minInput.HCTime ? (d = u) : d > j && (d = j),
          d !== u && c.xAxis[0].setExtremes(h ? d : e.min, h ? e.max : d, u, u, { trigger: 'rangeSelectorInput' }));
      };
    },
    ...
    render: function (a, b) {
      ...
      if (
        !x &&
        ((c.group = v = e.g('range-selector-buttons').add()),
        (c.zoomText = e.text(g.rangeSelectorZoom, p(m.x, r), 15).css(i.labelStyle).add(v)),
        (s = p(m.x, r) + c.zoomText.getBBox().width + 5),
        n(c.buttonOptions, function (a, b) {
          j[b] = e
            .button(
              a.text,
              s,
        ...
        (c.div = k = ca('div', null, { position: 'relative', height: 0, zIndex: 1 })),
          f.parentNode.insertBefore(k, f),
          (c.inputGroup = k = e.g('input-group').add()),
          (k.offset = 0),
          c.drawInput('min'),
          c.drawInput('max');
      v[x ? 'animate' : 'attr']({ translateY: u.buttonTop });
      o !== !1 &&
        (k.align(
          w({ y: u.inputTop, width: k.offset, x: h && u.inputTop < (h.y || 0) + h.height - d.spacing[0] ? -40 : 0 }, i.inputPosition),
          !0,
          d.spacingBox
        ),
        t(o) || ((d = v.getBBox()), k[k.translateX < d.x + d.width + 10 ? 'hide' : 'show']()),
  ...
  z.RangeSelector = Jb;
  Ca.prototype.callbacks.push(function (a) {
    function b() {
    ...
    var f,
      ...
      h = a.rangeSelector;
    g &&
      (D(a.xAxis[0], 'afterSetExtremes', d),
      S(a, 'drawChartBox', function (a) {
  ...
  z.StockChart = z.stockChart = function (a, b, c) {
    var d = Da(a) || a.nodeName,
      e = arguments[d ? 1 : 0],
      f = e.series,
      g,
      h = p(e.navigator && e.navigator.enabled, !0) ? { startOnTick: !1, endOnTick: !1 } : null,
      i = { marker: { enabled: !1, radius: 2 } },
      j = { shadow: !1, borderWidth: 0 };
    e.xAxis = sa(ua(e.xAxis || {}), function (a) {
      return C(
        { minPadding: 0, maxPadding: 0, ordinal: !0, title: { text: null }, labels: { overflow: 'justify' }, showLastLabel: !0 },
        a,
        { type: 'datetime', categories: null },
        h
      );
    });
    e.yAxis = sa(ua(e.yAxis || {}), function (a) {
      g = p(a.opposite, !0);
    ...
    e = C(
      ...
      e,
      { _stock: !0, chart: { inverted: !1 } }
    );
    e.series = f;
    return d ? new Ca(a, e, c) : new Ca(e, b);
  };
  S(ab.prototype, 'init', function (a, b, c) {
  ...
  S(F.prototype, 'autoLabelAlign', function (a) {
    var b = this.chart,
      c = this.options,
  ...
  S(F.prototype, 'getPlotLinePath', function (a, b, c, d, e, f) {
    ...
    w = g.isXAxis
      ? t(g.options.yAxis)
        ? [i.yAxis[g.options.yAxis]]
        : sa(h, function (a) {
            return a.yAxis;
          })
      : t(g.options.xAxis)
      ? [i.xAxis[g.options.xAxis]]
      : sa(h, function (a) {
          return a.xAxis;
        });
    ...
    v = w.length ? [] : [g.isXAxis ? i.yAxis[0] : i.xAxis[0]];
    n(w, function (a) {
      ra(a, v) === -1 && v.push(a);
    });
    x = p(f, g.translate(b, null, null, d));
    isNaN(x) ||
      (g.horiz
        ? n(v, function (a) {
            var b;
            ...
            r = o + a.len;
            m = q = y(x + g.transB);
            if (m < k || m > k + g.width) e ? (m = q = E(s(k, m), k + g.width)) : (b = !0);
            b || u.push('M', m, o, 'L', q, r);
          })
        : n(v, function (a) {
            var b;
            m = a.pos;
            q = m + a.len;
            o = r = y(l + g.height - x);
            if (o < l || o > l + g.height) e ? (o = r = E(s(l, o), g.top + g.height)) : (b = !0);
            b || u.push('M', m, o, 'L', q, r);
          }));
    return u.length > 0 ? j.crispPolyLine(u, c || 1) : null;
  });
  ...
  xa.prototype.crispPolyLine = function (a, b) {
    ...
    for (c = 0; c < a.length; c += 6)
      a[c + 1] === a[c + 4] && (a[c + 1] = a[c + 4] = y(a[c + 1]) - (b % 2) / 2),
        a[c + 2] === a[c + 5] && (a[c + 2] = a[c + 5] = y(a[c + 2]) + (b % 2) / 2);
    return a;
  };
  if ($a === z.VMLRenderer) nb.prototype.crispPolyLine = xa.prototype.crispPolyLine;
  S(F.prototype, 'hideCrosshair', function (a, b) {
    a.call(this, b);
    if (this.crossLabel) this.crossLabel = this.crossLabel.hide();
  });
  S(F.prototype, 'drawCrosshair', function (a, b, c) {
    var d, e;
    a.call(this, b, c);
    if (t(this.crosshair.label) && this.crosshair.label.enabled) {
      ...
      if (!k)
        k = this.crossLabel = a.renderer
          ...
          .css(w({ color: 'white', fontWeight: 'normal', fontSize: '11px', textAlign: 'center' }, f.style))
          .add();
      ...
      k.attr({
        text: m ? Ka(m, { value: b }) : f.formatter.call(this, b),
      ...
      b = k.getBBox();
      if (g) {
        if ((q && !h) || (!q && h)) j = k.y - b.height;
      } else j = k.y - b.height / 2;
      g
        ? ((d = i - b.x), (e = i + this.width - b.x))
        : ((d = this.labelAlign === 'left' ? i : 0), (e = this.labelAlign === 'right' ? i + this.width : a.chartWidth));
  ...
  var hc = ga.init,
    ic = ga.processData,
    jc = Ha.prototype.tooltipFormatter;
  ga.init = function () {
    hc.apply(this, arguments);
    this.setCompare(this.options.compare);
  };
  ga.setCompare = function (a) {
    this.modifyValue =
      a === 'value' || a === 'percent'
        ? function (b, c) {
            var d = this.compareValue;
            if (b !== u && ((b = a === 'value' ? b - d : (b = 100 * (b / d) - 100)), c)) c.change = b;
            return b;
          }
        : null;
  ...
  ga.processData = function () {
    ...
    if (this.xAxis && this.processedYData) {
      ...
      e = d.length;
      this.pointArrayMap && (b = ra(this.pointValKey || 'y', this.pointArrayMap));
      for (a = 0; a < e; a++)
        if (((f = b > -1 ? d[a][b] : d[a]), typeof f === 'number' && c[a] >= this.xAxis.min && f !== 0)) {
          this.compareValue = f;
          break;
        }
    }
  };
  S(ga, 'getExtremes', function (a) {
    var b;
    a.apply(this, [].slice.call(arguments, 1));
    if (this.modifyValue)
      (b = [this.modifyValue(this.dataMin), this.modifyValue(this.dataMax)]), (this.dataMin = Oa(b)), (this.dataMax = Ea(b));
  });
  ...
  Ha.prototype.tooltipFormatter = function (a) {
    a = a.replace(
      '{point.change}',
      (this.change > 0 ? '+' : '') + z.numberFormat(this.change, p(this.series.tooltipOptions.changeDecimals, 2))
    );
  ...
  S(P.prototype, 'render', function (a) {
    if (this.chart.options._stock && this.xAxis)
      !this.clipBox && this.animate
        ? ((this.clipBox = C(this.chart.clipBox)), (this.clipBox.width = this.xAxis.len), (this.clipBox.height = this.yAxis.len))
        : this.chart[this.sharedClipKey] &&
          (Ta(this.chart[this.sharedClipKey]), this.chart[this.sharedClipKey].attr({ width: this.xAxis.len, height: this.yAxis.len }));
    a.call(this);
  });
  w(z, {
    Color: va,
