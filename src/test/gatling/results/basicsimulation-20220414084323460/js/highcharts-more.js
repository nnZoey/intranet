...
(function (m) {
  ...
  F(J.prototype, {
    init: function (a, b, c) {
      ...
      (a = a.background) &&
        s([].concat(K(a)).reverse(), function (a) {
    ...
    N = {
      ...
      getPlotBandPath: function (a, b, c) {
        ...
        this.options.gridLineInterpolation === 'polygon'
          ...
          : ((a = Math.max(a, this.min)),
            ...
            f || ((j[0] = this.translate(a)), (j[1] = this.translate(b))),
            (j = Q(j, function (a) {
              l.test(a) && (a = (A(a, 10) * e) / 100);
              return a;
            })),
            c.shape === 'circle' || !f
              ? ((a = -Math.PI / 2), (b = Math.PI * 1.5), (i = !0))
              : ((a = g + this.translate(a)), (b = g + this.translate(b))),
            (d = this.chart.renderer.symbols.arc(this.left + d[0], this.top + d[1], j[0], j[0], {
              start: Math.min(a, b),
              end: Math.max(a, b),
      ...
      getPlotLinePath: function (a, b) {
        var c = this,
          ...
          i;
        c.isCircular
          ? (i = ['M', d[0] + g.plotLeft, d[1] + g.plotTop, 'L', e.x, e.y])
          : c.options.gridLineInterpolation === 'circle'
          ? (a = c.translate(a)) && (i = c.getLinePath(0, a))
          : (s(g.xAxis, function (a) {
              a.pane === c.pane && (j = a);
            }),
            (i = []),
            (a = c.translate(a)),
            (d = j.tickPositions),
            j.autoConnect && (d = d.concat([d[0]])),
  ...
  v(y, 'getLabelPosition', function (a, b, c, d, g, e, j, l, i) {
    var f = this.axis,
      ...
      n = 20,
      k = e.align,
      m = (((f.translate(this.pos) + f.startAngleRad + Math.PI / 2) / Math.PI) * 180) % 360;
    f.isRadial
      ? ((a = f.getPosition(this.pos, f.center[2] / 2 + q(e.distance, -25))),
        e.rotation === 'auto'
          ? d.attr({ rotation: m })
          : h === null && (h = f.chart.renderer.fontMetrics(d.styles.fontSize).b - d.getBBox().height / 2),
        k === null &&
          (f.isCircular
            ? (this.label.getBBox().width > (f.len * f.tickInterval) / (f.max - f.min) && (n = 0),
              (k = m > n && m < 180 - n ? 'left' : m > 180 + n && m < 360 - n ? 'right' : 'center'))
            : (k = 'center'),
          d.attr({ align: k })),
        (a.x += e.x),
        (a.y += h))
      : (a = a.call(this, b, c, d, g, e, j, l, i));
    return a;
  });
  v(y, 'getMarkPath', function (a, b, c, d, g, e, j) {
    var l = this.axis;
    l.isRadial
      ? ((a = l.getPosition(this.pos, l.center[2] / 2 + d)), (b = ['M', b, c, 'L', a.x, a.y]))
      : (b = a.call(this, b, c, d, g, e, j));
    return b;
  });
  ...
  k.arearange = u(k.area, {
    ...
    getGraphPath: function () {
      var a = this.points,
        ...
        l;
      l = this.options;
      for (var i = l.step, d = a.length; d--; )
        (e = a[d]),
          !e.isNull && (!a[d + 1] || a[d + 1].isNull) && c.push({ plotX: e.plotX, plotY: e.plotLow }),
          (j = { plotX: e.plotX, plotY: e.plotHigh, isNull: e.isNull }),
          c.push(j),
          b.push(j),
          !e.isNull && (!a[d - 1] || a[d - 1].isNull) && c.push({ plotX: e.plotX, plotY: e.plotLow });
      a = g.call(this, a);
      ...
      translate: function () {
        ...
        s(b.points, function (a) {
          ...
          a.tooltipPos = g.inverted
            ? [c.len + c.pos - g.plotLeft - h - f / 2, d.len + d.pos - g.plotTop - l.x - l.width / 2, f]
            : [d.left - g.plotLeft + l.x + l.width / 2, c.pos - g.plotTop + h + f / 2, f];
        });
      },
      directTouch: !0,
  ...
  B = {
    ...
    translate: function () {
      ...
      s(this.points, function (d) {
        ...
        h && typeof h === 'number'
          ? ((h = (h / 180) * Math.PI), (n = Math.max(a.startAngleRad - h, Math.min(a.endAngleRad + h, n))))
          : b.wrap === !1 && (n = Math.max(a.startAngleRad, Math.min(a.endAngleRad, n)));
        n = (n * 180) / Math.PI;
        d.shapeType = 'path';
        d.shapeArgs = {
    ...
    drawPoints: function () {
      ...
      c
        ...
        : (a.pivot = e
            ...
            .attr({ 'stroke-width': g.borderWidth || 0, stroke: g.borderColor || 'silver', fill: g.backgroundColor || 'black', zIndex: 2 })
            .translate(b[0], b[1])
            .add(a.group));
    },
    animate: function (a) {
  ...
  k.boxplot = u(k.column, {
    ...
    drawPoints: function () {
      ...
      s(a.points, function (p) {
        ...
        if (p.plotY !== void 0)
          if (
            ((d = p.pointAttr[p.selected ? 'selected' : '']),
            (v = B.width),
            (u = C(B.x)),
            (w = u + v),
            (x = E(v / 2)),
            (g = C(y ? p.q1Plot : p.lowPlot)),
            (e = C(y ? p.q3Plot : p.lowPlot)),
            (j = C(p.highPlot)),
            (l = C(p.lowPlot)),
            (m.stroke = p.stemColor || b.stemColor || A),
            (m['stroke-width'] = q(p.stemWidth, b.stemWidth, b.lineWidth)),
            (m.dashstyle = p.stemDashStyle || b.stemDashStyle),
            (o.stroke = p.whiskerColor || b.whiskerColor || A),
            (o['stroke-width'] = q(p.whiskerWidth, b.whiskerWidth, b.lineWidth)),
            (r.stroke = p.medianColor || b.medianColor || A),
            (r['stroke-width'] = q(p.medianWidth, b.medianWidth, b.lineWidth)),
            (f = (m['stroke-width'] % 2) / 2),
            (h = u + x + f),
            (k = ['M', h, e, 'L', h, j, 'M', h, g, 'L', h, l]),
            y &&
              ((f = (d['stroke-width'] % 2) / 2),
              (h = C(h) + f),
              (g = C(g) + f),
              (e = C(e) + f),
              (u += f),
              (w += f),
              (H = ['M', u, e, 'L', u, g, 'L', w, g, 'L', w, e, 'L', u, e, 'z'])),
            D &&
              ((f = (o['stroke-width'] % 2) / 2),
              (j += f),
              (l += f),
              (z = /%$/.test(D) ? (x * parseFloat(D)) / 100 : D / 2),
              (I = ['M', h - z, j, 'L', h + z, j, 'M', h - z, l, 'L', h + z, l])),
            (f = (r['stroke-width'] % 2) / 2),
            (i = E(p.medianPlot) + f),
            (t = ['M', u, i, 'L', w, i]),
            n)
          )
            p.stem.animate({ d: k }), D && p.whiskers.animate({ d: I }), y && p.box.animate({ d: H }), p.medianShape.animate({ d: t });
          else {
  ...
  k.waterfall = u(k.column, {
    ...
    translate: function () {
      ...
      for (c = 0, a = d.length; c < a; c++) {
        ...
        if (g.isSum) g.y = l;
        else if (g.isIntermediateSum) g.y = l - f;
        j = M(i, i + g.y) + h[0];
        e.y = b.translate(j, 0, 1);
        if (g.isSum)
          (e.y = b.translate(h[1], 0, 1)), (e.height = Math.min(b.translate(h[0], 0, 1), b.len) - e.y + this.minPointLengthOffset);
        else if (g.isIntermediateSum)
          (e.y = b.translate(h[1], 0, 1)), (e.height = Math.min(b.translate(f, 0, 1), b.len) - e.y + this.minPointLengthOffset), (f = h[1]);
        else {
    ...
    processData: function (a) {
      ...
      for (h = 0; h < g; h++)
        (f = b[h]),
          (d = c && c[h] ? c[h] : {}),
          f === 'sum' || d.isSum ? (b[h] = j) : f === 'intermediateSum' || d.isIntermediateSum ? (b[h] = e) : ((j += f), (e += f)),
          (l = Math.min(j, l)),
          (i = Math.max(j, i));
    ...
    getGraphPath: function () {
      ...
      for (j = 1; j < b; j++)
        (e = a[j].shapeArgs),
          (g = a[j - 1].shapeArgs),
          (e = ['M', g.x + g.width, g.y + c, 'L', e.x, g.y + c]),
          a[j - 1].y < 0 && ((e[2] += g.height), (e[5] += g.height)),
          (d = d.concat(e));
      return d;
    },
    getExtremes: r,
  ...
  k.bubble = u(k.scatter, {
    ...
    getRadii: function (a, b, c, d) {
      ...
      for (e = 0, g = l.length; e < g; e++)
        (j = l[e]),
          f.sizeByAbsoluteValue && j !== null && ((j = Math.abs(j - n)), (b = Math.max(b - n, Math.abs(a - n))), (a = 0)),
          j === null
            ? (j = null)
            : j < a
            ? (j = c / 2 - 1)
            : ((j = k > 0 ? (j - a) / k : 0.5), h && j >= 0 && (j = Math.sqrt(j)), (j = x.ceil(c + j * (d - c)) / 2)),
          i.push(j);
      this.radii = i;
    },
    animate: function (a) {
    ...
    translate: function () {
      ...
      for (a = b.length; a--; )
        (c = b[a]),
          (d = g ? g[a] : 0),
          typeof d === 'number' && d >= this.minPxSize / 2
            ? ((c.shapeType = 'circle'),
  ...
  L.prototype.beforePadding = function () {
    ...
    s(this.series, function (b) {
      ...
      if (b.bubblePadding && (b.visible || !c.options.chart.ignoreHiddenSeries))
        if (((a.allowZoomOutside = !0), o.push(b), e))
          s(['minSize', 'maxSize'], function (a) {
            ...
            (b.maxPxSize = i.maxSize),
            (b = b.zData),
            b.length &&
              ((h = q(g.zMin, x.min(h, x.max(O(b), g.displayNegative === !1 ? g.zThreshold : -Number.MAX_VALUE)))),
              (n = q(g.zMax, x.max(n, P(b)))));
    });
    s(o, function (a) {
      var b = a[j],
        c = b.length,
  ...
  (function () {
    function a(a, b) {
      ...
      if (c.polar) {
        if (c.renderer.isSVG)
          d === !0 && (d = {}),
            b
              ? ((c = { translateX: h[0] + n, translateY: h[1] + k, scaleX: 0.001, scaleY: 0.001 }), i.attr(c), f && f.attr(c))
              : ((c = { translateX: n, translateY: k, scaleX: 1, scaleY: 1 }),
                i.animate(c, d),
                f && f.animate(c, d),
                (this.animate = null));
      } else a.call(this, b);
    ...
    b.toXY = function (a) {
      ...
      this.kdByAngle
        ? ((c = ((d / Math.PI) * 180 + this.xAxis.pane.options.startAngle) % 360), c < 0 && (c += 360), (a.clientX = c))
        : (a.clientX = a.plotX);
    };
    k.spline &&
      v(k.spline.prototype, 'getPointSpline', function (a, b, c, d) {
        var i, f, h, n, k, m, o;
        if (this.chart.polar) {
          i = c.plotX;
          f = c.plotY;
          ...
          if (a && h)
            (n = a.plotX),
              ...
              (h = (1.5 * i + b) / 2.5),
              (o = (1.5 * f + m) / 2.5),
              (b = Math.sqrt(Math.pow(n - i, 2) + Math.pow(k - f, 2))),
              (m = Math.sqrt(Math.pow(h - i, 2) + Math.pow(o - f, 2))),
              (n = Math.atan2(k - f, n - i)),
              (k = Math.atan2(o - f, h - i)),
              (o = Math.PI / 2 + (n + k) / 2),
              Math.abs(n - o) > Math.PI / 2 && (o -= Math.PI),
              (n = i + Math.cos(o) * b),
              (k = f + Math.sin(o) * b),
              (h = i + Math.cos(Math.PI + o) * m),
              (o = f + Math.sin(Math.PI + o) * m),
              (c.rightContX = h),
              (c.rightContY = o);
          d
    ...
    v(b, 'animate', a);
    if (k.column)
      (d = k.column.prototype),
        v(d, 'animate', a),
        v(d, 'translate', function (a) {
          var b = this.xAxis,
            c = this.yAxis.len,
            d = b.center,
            i = b.startAngleRad,
          ...
          if (b.isRadial) {
            ...
            for (k = b.length; k--; )
              (h = b[k]),
                ...
                (h.shapeType = 'path'),
                (h.shapeArgs = {
                  d: f.symbols.arc(d[0], d[1], c - h.plotY, null, { start: a, end: a + h.pointWidth, innerR: c - q(h.yBottom, c) }),
                }),
                this.toXY(h),
                (h.tooltipPos = [h.plotX, h.plotY]),
                (h.ttBelow = h.plotY > d[1]);
          }
        }),
