package vn.leap.intranet.config.timezone;
...
import vn.leap.intranet.repository.timezone.DateTimeWrapper;
import vn.leap.intranet.repository.timezone.DateTimeWrapperRepository;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM leap_date_time_wrapper where id=%d", fieldName, id);
    }
