...
import vn.leap.intranet.service.EventQueryService;
import vn.leap.intranet.service.EventService;
import vn.leap.intranet.service.criteria.EventCriteria;
import vn.leap.intranet.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link vn.leap.intranet.domain.Event}.
 */
@RestController
@RequestMapping("/api")
public class EventResource {
     ...
     */
    @GetMapping("/events")
    public ResponseEntity<List<Event>> getAllEvents(EventCriteria criteria) {
        log.debug("REST request to get Events by criteria: {}", criteria);
        List<Event> entityList = eventQueryService.findByCriteria(criteria);
