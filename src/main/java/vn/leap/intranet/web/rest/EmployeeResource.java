...
import vn.leap.intranet.service.EmployeeService;
import vn.leap.intranet.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link vn.leap.intranet.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
public class EmployeeResource {
    ...
    @GetMapping("/employees_person")
    public List<Object> getAllEmployeesList(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of Employees");
        List<Object> page = employeeRepository.findAllEmployee();
        return page;
    }
